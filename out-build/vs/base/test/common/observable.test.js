...
define(["require", "exports", "assert", "vs/base/common/event", "vs/base/common/observable", "vs/base/common/observableInternal/base"], function (require, exports, assert, event_1, observable_1, base_1) {
    ...
    suite('observables', () => {
        ...
        test('reading derived in transaction unsubscribes unnecessary observables', () => {
            ...
            const myObs1 = new $uT('myObs1', 0, log);
        ...
        test('avoid recomputation of deriveds that are no longer read', () => {
            const log = new Log();
            const myObsShouldRead = new $uT('myObsShouldRead', true, log);
            const myObs1 = new $uT('myObs1', 0, log);
            const myComputed1 = (0, observable_1.derived)(reader => {
                /** @description myComputed1 */
        ...
        test('self-disposing autorun', () => {
            const log = new Log();
            const observable1 = new $uT('myObservable1', 0, log);
            const myObservable2 = new $uT('myObservable2', 0, log);
            const myObservable3 = new $uT('myObservable3', 0, log);
        ...
        test('changing observables in endUpdate', () => {
            const log = new Log();
            const myObservable1 = new $uT('myObservable1', 0, log);
            const myObservable2 = new $uT('myObservable2', 0, log);
        ...
        test('set dependency in derived', () => {
            const log = new Log();
            const myObservable = new $uT('myObservable', 0, log);
            const myComputed = (0, observable_1.derived)(reader => {
                /** @description myComputed */
    ...
    class $tT {
        ...
        beginUpdate(observable) {
            this.a++;
            this.b.log(`${this.debugName}.beginUpdate (count ${this.a})`);
        }
        endUpdate(observable) {
            this.b.log(`${this.debugName}.endUpdate (count ${this.a})`);
            this.a--;
        }
        handleChange(observable, change) {
            this.b.log(`${this.debugName}.handleChange (count ${this.a})`);
        }
        handlePossibleChange(observable) {
            this.b.log(`${this.debugName}.handlePossibleChange`);
        }
    }
    exports.$tT = $tT;
    class $uT extends base_1.$4c {
        constructor(debugName, initialValue, b) {
            super();
            this.debugName = debugName;
            this.b = b;
            this.a = initialValue;
        ...
        f() {
            this.b.log(`${this.debugName}.firstObserverAdded`);
        }
        g() {
            this.b.log(`${this.debugName}.lastObserverRemoved`);
        }
        get() {
            this.b.log(`${this.debugName}.get`);
            return this.a;
        }
        set(value, tx, change) {
            if (this.a === value) {
            ...
            this.b.log(`${this.debugName}.set (value ${value})`);
            this.a = value;
