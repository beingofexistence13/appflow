...
define(["require", "exports", "vs/editor/common/core/range", "vs/workbench/services/search/common/search"], function (require, exports, range_1, search_1) {
    ...
    exports.$OMb = exports.$NMb = void 0;
    function editorMatchToTextSearchResult(matches, model, previewOptions) {
        ...
        return new search_1.$tI(lineTexts.join('\n') + '\n', matches.map(m => new range_1.$ks(m.range.startLineNumber - 1, m.range.startColumn - 1, m.range.endLineNumber - 1, m.range.endColumn - 1)), previewOptions);
    }
    /**
     ...
     */
    function $NMb(matches, model, previewOptions) {
    ...
    exports.$NMb = $NMb;
    function $OMb(matches, model, query) {
        const results = [];
        let prevLine = -1;
