...
define(["require", "exports", "vs/editor/common/core/characterClassifier"], function (require, exports, characterClassifier_1) {
    ...
    exports.$AY = exports.$zY = exports.$yY = exports.State = void 0;
    var State;
    (function (State) {
    ...
    function getClassifier() {
        if (_classifier === null) {
            _classifier = new characterClassifier_1.$Hs(0 /* CharacterClass.None */);
    ...
    class $zY {
        ...
        static computeLinks(model, stateMachine = getStateMachine()) {
            ...
            for (let i = 1, lineCount = model.getLineCount(); i <= lineCount; i++) {
                ...
                while (j < len) {
                    ...
                    if (state === 13 /* State.Accept */) {
                        ...
                        if (chClass === 1 /* CharacterClass.ForceTermination */) {
                            result.push($zY.a(classifier, line, i, linkBeginIndex, j));
                ...
                if (state === 13 /* State.Accept */) {
                    result.push($zY.a(classifier, line, i, linkBeginIndex, len));
                }
            }
            return result;
        }
