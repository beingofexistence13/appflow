define(["require", "exports", "assert", "vs/platform/extensions/common/extensionValidator"], function (require, exports, assert, extensionValidator_1) {
    ...
    suite('Extension Version Validator', () => {
        ...
        test('isValidVersionStr', () => {
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.0-dev'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.0'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.1'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.100'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.11.0'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('x.x.x'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.x.x'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.0'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.x'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('^0.10.0'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('*'), true);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.x.x.x'), false);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10'), false);
            assert.strictEqual((0, extensionValidator_1.$Bo)('0.10.'), false);
        });
        test('parseVersion', () => {
            function assertParseVersion(version, hasCaret, hasGreaterEquals, majorBase, majorMustEqual, minorBase, minorMustEqual, patchBase, patchMustEqual, preRelease) {
                const actual = (0, extensionValidator_1.$Co)(version);
        ...
        test('normalizeVersion', () => {
            function assertNormalizeVersion(version, majorBase, majorMustEqual, minorBase, minorMustEqual, patchBase, patchMustEqual, isMinimum, notBefore = 0) {
                const actual = (0, extensionValidator_1.$Do)((0, extensionValidator_1.$Co)(version));
        ...
        test('isValidVersion', () => {
            function testIsValidVersion(version, desiredVersion, expectedResult) {
                const actual = (0, extensionValidator_1.$Eo)(version, productVersion, desiredVersion);
        ...
        test('isValidExtensionVersion', () => {
            function testExtensionVersion(version, desiredVersion, isBuiltin, hasMain, expectedResult) {
                ...
                const reasons = [];
                const actual = (0, extensionValidator_1.$Go)(version, productVersion, manifest, isBuiltin, reasons);
        ...
        test('isValidExtensionVersion checks browser only extensions', () => {
            ...
            assert.strictEqual((0, extensionValidator_1.$Go)('1.44.0', undefined, manifest, false, []), false);
        });
    });
});
