    ...
    let $zac = class $zac {
        constructor(instantiationService, environmentService) {
            ...
            if (environmentService.args['export-default-configuration']) {
                instantiationService.createInstance(configurationExportHelper_1.$yac);
            }
        }
    };
    exports.$zac = $zac;
    exports.$zac = $zac = __decorate([
        __param(0, instantiation_1.$Ah),
        __param(1, environmentService_1.$1$b)
    ], $zac);
    platform_1.$8m.as(contributions_1.Extensions.Workbench).registerWorkbenchContribution($zac, 3 /* LifecyclePhase.Restored */);
});
