...
define(["require", "exports", "assert", "sinon", "vs/workbench/common/views", "vs/base/common/lifecycle", "vs/base/common/arrays", "vs/workbench/test/browser/workbenchTestServices", "vs/platform/contextkey/common/contextkey", "vs/platform/contextkey/browser/contextKeyService", "vs/workbench/services/views/browser/viewDescriptorService", "vs/platform/registry/common/platform", "vs/platform/instantiation/common/descriptors", "vs/platform/storage/common/storage", "vs/base/common/event", "vs/workbench/services/views/common/viewContainerModel", "vs/base/test/common/timeTravelScheduler", "vs/base/test/common/utils"], function (require, exports, assert, sinon, views_1, lifecycle_1, arrays_1, workbenchTestServices_1, contextkey_1, contextKeyService_1, viewDescriptorService_1, platform_1, descriptors_1, storage_1, event_1, viewContainerModel_1, timeTravelScheduler_1, utils_1) {
    ...
    class ViewDescriptorSequence {
        constructor(model) {
            ...
            model.onDidAddVisibleViewDescriptors(added => added.forEach(({ viewDescriptor, index }) => this.elements.splice(index, 0, viewDescriptor)), null, this.d);
            model.onDidRemoveVisibleViewDescriptors(removed => removed.sort((a, b) => b.index - a.index).forEach(({ index }) => this.elements.splice(index, 1)), null, this.d);
            model.onDidMoveVisibleViewDescriptors(({ from, to }) => (0, arrays_1.$Hb)(this.elements, from.index, to.index), null, this.d);
        }
        dispose() {
            this.d = (0, lifecycle_1.$fc)(this.d);
        }
    }
    suite('ViewContainerModel', () => {
        ...
        let storageService;
        setup(() => {
            const instantiationService = (0, workbenchTestServices_1.$lec)(undefined, disposableStore);
            contextKeyService = disposableStore.add(instantiationService.createInstance(contextKeyService_1.$xtb));
            instantiationService.stub(contextkey_1.$3i, contextKeyService);
            storageService = instantiationService.get(storage_1.$Vo);
            viewDescriptorService = disposableStore.add(instantiationService.createInstance(viewDescriptorService_1.$xAb));
        });
        teardown(() => {
        ...
        test('empty model', function () {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
        ...
        test('when contexts', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            assert.strictEqual(testObject.visibleViewDescriptors.length, 0);
            ...
            const viewDescriptor = {
                ...
                ctorDescriptor: null,
                name: 'Test View 1',
                when: contextkey_1.$Ii.equals('showview1', true)
            };
            ViewsRegistry.registerViews([viewDescriptor], container);
        ...
        test('when contexts - multiple', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const view1 = { id: 'view1', ctorDescriptor: null, name: 'Test View 1' };
            const view2 = { id: 'view2', ctorDescriptor: null, name: 'Test View 2', when: contextkey_1.$Ii.equals('showview2', true) };
        ...
        test('when contexts - multiple 2', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const view1 = { id: 'view1', ctorDescriptor: null, name: 'Test View 1', when: contextkey_1.$Ii.equals('showview1', true) };
        ...
        test('view states', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
        ...
        test('view states and when contexts', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            storageService.store(`${container.id}.state.hidden`, JSON.stringify([{ id: 'view1', isHidden: true }]), 0 /* StorageScope.PROFILE */, 1 /* StorageTarget.MACHINE */);
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
        ...
        test('view states and when contexts multiple views', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            storageService.store(`${container.id}.state.hidden`, JSON.stringify([{ id: 'view1', isHidden: true }]), 0 /* StorageScope.PROFILE */, 1 /* StorageTarget.MACHINE */);
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            ...
            const view1 = {
                ...
                ctorDescriptor: null,
                name: 'Test View 1',
                when: contextkey_1.$Ii.equals('showview', true)
            };
            const view2 = {
                id: 'view2',
                ctorDescriptor: null,
        ...
        test('remove event is not triggered if view was hidden and removed', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('add event is not triggered if view was set visible (when visible) and not active', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('remove event is not triggered if view was hidden and not active', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('add event is not triggered if view was set visible (when not visible) and not active', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('added view descriptors are in ascending order in the event', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
        ...
        test('add event is triggered only once when view is set visible while it is set active', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('add event is not triggered only when view is set hidden while it is set active', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor = {
        ...
        test('#142087: view descriptor visibility is not reset', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const viewDescriptor = {
                id: 'view1',
            ...
            storageService.store((0, viewContainerModel_1.$vAb)('test.state'), JSON.stringify([{
        ...
        test('remove event is triggered properly if mutliple views are hidden at the same time', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
        ...
        test('add event is triggered properly if mutliple views are hidden at the same time', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor1 = {
        ...
        test('add and remove events are triggered properly if mutliple views are hidden and added at the same time', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const testObject = viewDescriptorService.getViewContainerModel(container);
            const target = disposableStore.add(new ViewDescriptorSequence(testObject));
            const viewDescriptor1 = {
        ...
        test('newly added view descriptor is hidden if it was toggled hidden in storage before adding', () => (0, timeTravelScheduler_1.$kT)({ useFakeTimers: true }, async () => {
            container = ViewContainerRegistry.registerViewContainer({ id: 'test', title: { value: 'test', original: 'test' }, ctorDescriptor: new descriptors_1.$yh({}) }, 0 /* ViewContainerLocation.Sidebar */);
            const viewDescriptor = {
                id: 'view1',
                ctorDescriptor: null,
