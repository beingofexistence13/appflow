...
define(["require", "exports", "assert", "vs/workbench/services/textMate/browser/arrayOperation"], function (require, exports, assert, arrayOperation_1) {
    ...
    suite('array operation', () => {
        ...
        test('simple', () => {
            const edit = new arrayOperation_1.$ABb([
                new arrayOperation_1.$BBb(4, 3, 2),
                new arrayOperation_1.$BBb(8, 0, 2),
                new arrayOperation_1.$BBb(9, 2, 0),
            ]);
            ...
            const transformer = new arrayOperation_1.$CBb(edit);
