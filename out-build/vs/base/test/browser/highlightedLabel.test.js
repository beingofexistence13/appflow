...
define(["require", "exports", "assert", "vs/base/browser/ui/highlightedlabel/highlightedLabel", "vs/base/test/common/utils"], function (require, exports, assert, highlightedLabel_1, utils_1) {
    ...
    suite('HighlightedLabel', () => {
        let label;
        setup(() => {
            label = new highlightedLabel_1.$JR(document.createElement('div'), { supportIcons: true });
        });
        ...
        test('escapeNewLines', () => {
            ...
            let escaped = highlightedLabel_1.$JR.escapeNewLines('ACTION\r\n_TYPE2', highlights);
            ...
            escaped = highlightedLabel_1.$JR.escapeNewLines('ACTION\r\n_TYPE2', highlights);
            assert.strictEqual(escaped, 'ACTION\u23CE_TYPE2');
