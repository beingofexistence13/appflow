define(["require", "exports", "assert", "vs/base/test/common/utils", "vs/editor/common/core/cursorColumns"], function (require, exports, assert, utils_1, cursorColumns_1) {
    ...
    suite('CursorMove', () => {
        ...
        test('nextRenderTabStop', () => {
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(0, 4), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(1, 4), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(2, 4), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(3, 4), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(4, 4), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(5, 4), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(6, 4), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(7, 4), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(8, 4), 12);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(0, 2), 2);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(1, 2), 2);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(2, 2), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(3, 2), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(4, 2), 6);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(5, 2), 6);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(6, 2), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(7, 2), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(8, 2), 10);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(0, 1), 1);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(1, 1), 2);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(2, 1), 3);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(3, 1), 4);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(4, 1), 5);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(5, 1), 6);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(6, 1), 7);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(7, 1), 8);
            assert.strictEqual(cursorColumns_1.$mt.nextRenderTabStop(8, 1), 9);
        });
        test('visibleColumnFromColumn', () => {
            function testVisibleColumnFromColumn(text, tabSize, column, expected) {
                assert.strictEqual(cursorColumns_1.$mt.visibleColumnFromColumn(text, column, tabSize), expected);
            }
        ...
        test('columnFromVisibleColumn', () => {
            function testColumnFromVisibleColumn(text, tabSize, visibleColumn, expected) {
                assert.strictEqual(cursorColumns_1.$mt.columnFromVisibleColumn(text, visibleColumn, tabSize), expected);
            }
        ...
        test('toStatusbarColumn', () => {
            function t(text, tabSize, column, expected) {
                assert.strictEqual(cursorColumns_1.$mt.toStatusbarColumn(text, column, tabSize), expected, `<<t('${text}', ${tabSize}, ${column}, ${expected})>>`);
            }
            t('    spaces', 4, 1, 1);
            t('    spaces', 4, 2, 2);
            t('    spaces', 4, 3, 3);
