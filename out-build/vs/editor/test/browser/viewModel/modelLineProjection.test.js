...
define(["require", "exports", "assert", "vs/base/test/common/utils", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/languages", "vs/editor/common/languages/nullTokenize", "vs/editor/common/modelLineProjectionData", "vs/editor/common/viewModel/modelLineProjection", "vs/editor/common/viewModel/monospaceLineBreaksComputer", "vs/editor/common/viewModel/viewModelLines", "vs/editor/test/browser/config/testConfiguration", "vs/editor/test/common/testTextModel"], function (require, exports, assert, utils_1, position_1, range_1, languages, nullTokenize_1, modelLineProjectionData_1, modelLineProjection_1, monospaceLineBreaksComputer_1, viewModelLines_1, testConfiguration_1, testTextModel_1) {
    ...
    suite('Editor ViewModel - SplitLinesCollection', () => {
        ...
        function withSplitLinesCollection(text, callback) {
            ...
            const lineBreaksComputerFactory = new monospaceLineBreaksComputer_1.$rY(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters);
            ...
            const linesCollection = new viewModelLines_1.$kY(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent, wordBreak);
        ...
        test('Invalid line numbers', () => {
            ...
            withSplitLinesCollection(text, (model, linesCollection) => {
                ...
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(-1, 1), new position_1.$js(1, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(0, 1), new position_1.$js(1, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(1, 1), new position_1.$js(1, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(2, 1), new position_1.$js(2, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(3, 1), new position_1.$js(3, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(4, 1), new position_1.$js(4, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(5, 1), new position_1.$js(5, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(6, 1), new position_1.$js(6, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(7, 1), new position_1.$js(6, 1));
                assert.deepStrictEqual(linesCollection.convertViewPositionToModelPosition(8, 1), new position_1.$js(6, 1));
            });
        });
        test('issue #3662', () => {
            const text = [
            ...
            withSplitLinesCollection(text, (model, linesCollection) => {
                ...
                for (let lineNumber = 0; lineNumber <= modelLineCount + 1; lineNumber++) {
                    ...
                    for (let column = lineMinColumn - 1; column <= lineMaxColumn + 1; column++) {
                        ...
                        const validViewPosition = new position_1.$js(viewLineNumber, viewColumn);
    ...
    suite('SplitLinesCollection', () => {
        ...
        test('getViewLinesData - no wrapping', () => {
            withSplitLinesCollection(model, 'off', 0, (splitLinesCollection) => {
                ...
                splitLinesCollection.setHiddenAreas([new range_1.$ks(2, 1, 4, 1)]);
        ...
        function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
            const configuration = new testConfiguration_1.$z0b({
                wordWrap: wordWrap,
    ...
    function createSplitLine(splitLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth, isVisible = true) {
        return (0, modelLineProjection_1.$jY)(createLineBreakData(splitLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth), isVisible);
    }
    function createLineBreakData(breakingLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth) {
        ...
        return new modelLineProjectionData_1.$FU(null, null, sums, breakingOffsetsVisibleColumn, wrappedTextIndentWidth);
    }
