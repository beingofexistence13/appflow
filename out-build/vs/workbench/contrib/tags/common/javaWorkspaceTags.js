...
define(["require", "exports"], function (require, exports) {
    ...
    exports.$Nac = exports.$Mac = exports.$Lac = exports.$Kac = exports.$Jac = exports.$Iac = exports.$Hac = void 0;
    exports.$Hac = /group\s*:\s*[\'\"](.*?)[\'\"]\s*,\s*name\s*:\s*[\'\"](.*?)[\'\"]\s*,\s*version\s*:\s*[\'\"](.*?)[\'\"]/g;
    exports.$Iac = /[\'\"]([^\'\"\s]*?)\:([^\'\"\s]*?)\:([^\'\"\s]*?)[\'\"]/g;
    exports.$Jac = /<dependencies>([\s\S]*?)<\/dependencies>/g;
    exports.$Kac = /<dependency>([\s\S]*?)<\/dependency>/g;
    exports.$Lac = /<groupId>([\s\S]*?)<\/groupId>/;
    exports.$Mac = /<artifactId>([\s\S]*?)<\/artifactId>/;
    exports.$Nac = [
        // azure
