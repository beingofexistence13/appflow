...
define(["require", "exports", "assert", "vs/base/common/strings", "vs/base/test/common/utils", "vs/editor/common/viewLayout/lineDecorations", "vs/editor/common/viewLayout/viewLineRenderer", "vs/editor/test/common/core/testLineToken"], function (require, exports, assert, strings, utils_1, lineDecorations_1, viewLineRenderer_1, testLineToken_1) {
    ...
    function createViewLineTokens(viewLineTokens) {
        return new testLineToken_1.$j$b(viewLineTokens);
    }
    function createPart(endIndex, foreground) {
        return new testLineToken_1.$i$b(endIndex, (foreground << 15 /* MetadataConsts.FOREGROUND_OFFSET */) >>> 0);
    }
    ...
    suite('viewLineRenderer.renderLine', () => {
        ...
        function assertCharacterReplacement(lineContent, tabSize, expected, expectedCharOffsetInPart) {
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, strings.$2e(lineContent), false, 0, createViewLineTokens([new testLineToken_1.$i$b(lineContent.length, 0)]), [], tabSize, 0, 0, 0, 0, -1, 'none', false, false, null));
        ...
        function assertParts(lineContent, tabSize, parts, expected, info) {
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens(parts), [], tabSize, 0, 0, 0, 0, -1, 'none', false, false, null));
        ...
        test('overflow', () => {
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, 'Hello world!', false, true, false, 0, createViewLineTokens([
                createPart(1, 0),
                createPart(2, 1),
                createPart(3, 2),
                createPart(4, 3),
        ...
        test('typical line', () => {
            ...
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, true, false, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'boundary', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(_actual), {
                html: [
        ...
        test('issue #2255: Weird line rendering part 1', () => {
            ...
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, true, false, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(_actual), {
                html: [
        ...
        test('issue #91178: after decoration type shown before cursor', () => {
            ...
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, false, lineText, false, true, false, 0, lineParts, [
                new lineDecorations_1.$MW(13, 13, 'dec1', 2 /* InlineDecorationType.After */),
                new lineDecorations_1.$MW(13, 13, 'dec2', 1 /* InlineDecorationType.Before */),
        ...
        test('issue microsoft/monaco-editor#280: Improved source code rendering for RTL languages', () => {
            ...
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, false, true, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(_actual), ({
                html: [
                    '<span dir="ltr">',
        ...
        test('issue #99589: Rendering whitespace influences bidi layout', () => {
            ...
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, lineText, false, false, true, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'all', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(_actual), ({
                html: [
                    '<span dir="ltr">',
        ...
        test('issue #6885: Splits large tokens', () => {
            ...
            function assertSplitsTokens(message, lineText, expectedOutput) {
                ...
                const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, true, false, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
        ...
        test('issue #21476: Does not split large tokens when ligatures are on', () => {
            ...
            function assertSplitsTokens(message, lineText, expectedOutput) {
                const lineParts = createViewLineTokens([createPart(lineText.length, 1)]);
                const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, true, false, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, true, null));
                assert.strictEqual(actual.html, '<span>' + expectedOutput.join('') + '</span>', message);
            }
            // A token with 101 chars
            {
        ...
        test('issue #20624: Unaligned surrogate pairs are corrupted at multiples of 50 columns', () => {
            ...
            const lineParts = createViewLineTokens([createPart(lineText.length, 1)]);
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, false, false, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
        ...
        test('issue #6885: Does not split large tokens in RTL text', () => {
            ...
            const lineParts = createViewLineTokens([createPart(lineText.length, 1)]);
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineText, false, false, true, 0, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
        ...
        test('issue #19673: Monokai Theme bad-highlighting in line wrap', () => {
            ...
            const _actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, lineText, false, true, false, 4, lineParts, [], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(_actual), ({
                html: [
                    '<span class="">\u00a0\u00a0\u00a0\u00a0</span>',
    ...
    function assertCharacterMapping3(actual, expectedInfo) {
        for (let i = 0; i < expectedInfo.length; i++) {
            ...
            assert.deepStrictEqual(actualDomPosition, new viewLineRenderer_1.$RW(partIndex, charIndex), `getDomPosition(${i + 1})`);
            ...
            const actualColumn = actual.getColumn(new viewLineRenderer_1.$RW(partIndex, charIndex), partLength);
    ...
    suite('viewLineRenderer.renderLine 2', () => {
        ...
        function testCreateLineParts(fontIsMonospace, lineContent, tokens, fauxIndentLength, renderWhitespace, selections) {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(fontIsMonospace, true, lineContent, false, true, false, fauxIndentLength, createViewLineTokens(tokens), [], 4, 0, 10, 10, 10, -1, renderWhitespace, false, false, selections));
        ...
        test('issue #18616: Inline decorations ending at the text length are no longer rendered', () => {
            ...
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens([createPart(21, 3)]), [new lineDecorations_1.$MW(1, 22, 'link', 0 /* InlineDecorationType.Regular */)], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), ({
                html: [
        ...
        test('issue #19207: Link in Monokai is not rendered correctly', () => {
            ...
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, lineContent, false, true, false, 0, createViewLineTokens([
                createPart(49, 6),
                createPart(51, 4),
                createPart(72, 6),
                createPart(74, 4),
                ...
                new lineDecorations_1.$MW(13, 51, 'detected-link', 0 /* InlineDecorationType.Regular */)
            ], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), ({
                html: [
        ...
        test('createLineParts render whitespace for selection with whole line selection', () => {
            assert.deepStrictEqual(testCreateLineParts(false, ' Hello world!\t', [
                ...
                createPart(6, 1),
                createPart(14, 2)
            ], 0, 'selection', [new viewLineRenderer_1.$PW(0, 14)]), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
                    '<span class="mtk0">Hel</span>',
                    '<span class="mtk1">lo</span>',
        ...
        test('createLineParts render whitespace for selection with selection spanning part of whitespace', () => {
            assert.deepStrictEqual(testCreateLineParts(false, ' Hello world!\t', [
                ...
                createPart(6, 1),
                createPart(14, 2)
            ], 0, 'selection', [new viewLineRenderer_1.$PW(0, 5)]), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
                    '<span class="mtk0">Hel</span>',
                    '<span class="mtk1">lo</span>',
        ...
        test('createLineParts render whitespace for selection with multiple selections', () => {
            assert.deepStrictEqual(testCreateLineParts(false, ' Hello world!\t', [
                ...
                createPart(6, 1),
                createPart(14, 2)
            ], 0, 'selection', [new viewLineRenderer_1.$PW(0, 5), new viewLineRenderer_1.$PW(9, 14)]), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
                    '<span class="mtk0">Hel</span>',
                    '<span class="mtk1">lo</span>',
        ...
        test('createLineParts render whitespace for selection with multiple, initially unsorted selections', () => {
            assert.deepStrictEqual(testCreateLineParts(false, ' Hello world!\t', [
                ...
                createPart(6, 1),
                createPart(14, 2)
            ], 0, 'selection', [new viewLineRenderer_1.$PW(9, 14), new viewLineRenderer_1.$PW(0, 5)]), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
                    '<span class="mtk0">Hel</span>',
                    '<span class="mtk1">lo</span>',
        ...
        test('createLineParts render whitespace for selection with selections next to each other', () => {
            assert.deepStrictEqual(testCreateLineParts(false, ' * S', [
                createPart(4, 0)
            ], 0, 'selection', [new viewLineRenderer_1.$PW(0, 1), new viewLineRenderer_1.$PW(1, 2), new viewLineRenderer_1.$PW(2, 3)]), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
        ...
        test('createLineParts can handle unsorted inline decorations', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, 'Hello world', false, true, false, 0, createViewLineTokens([createPart(11, 0)]), [
                new lineDecorations_1.$MW(5, 7, 'a', 0 /* InlineDecorationType.Regular */),
                new lineDecorations_1.$MW(1, 3, 'b', 0 /* InlineDecorationType.Regular */),
                new lineDecorations_1.$MW(2, 8, 'c', 0 /* InlineDecorationType.Regular */),
            ], 4, 0, 10, 10, 10, -1, 'none', false, false, null));
            // 01234567890
            // Hello world
            // ----aa-----
        ...
        test('issue #11485: Visible whitespace conflicts with before decorator attachment', () => {
            ...
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens([createPart(4, 3)]), [new lineDecorations_1.$MW(1, 2, 'before', 1 /* InlineDecorationType.Before */)], 4, 0, 10, 10, 10, -1, 'all', false, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #32436: Non-monospace font + visible whitespace + After decorator causes line to "jump"', () => {
            const lineContent = '\tbla';
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens([createPart(4, 3)]), [new lineDecorations_1.$MW(2, 3, 'before', 1 /* InlineDecorationType.Before */)], 4, 0, 10, 10, 10, -1, 'all', false, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
                    '<span class="mtkz" style="width:40px">\u2192\u00a0\u00a0\u00a0</span>',
        ...
        test('issue #30133: Empty lines don\'t render inline decorations', () => {
            const lineContent = '';
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens([createPart(0, 3)]), [new lineDecorations_1.$MW(1, 2, 'before', 1 /* InlineDecorationType.Before */)], 4, 0, 10, 10, 10, -1, 'all', false, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #37208: Collapsing bullet point containing emoji in Markdown document results in [??] character', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, '  1. 🙏', false, false, false, 0, createViewLineTokens([createPart(7, 3)]), [new lineDecorations_1.$MW(7, 8, 'inline-folded', 2 /* InlineDecorationType.After */)], 2, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #37401 #40127: Allow both before and after decorations on empty line', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, '', false, true, false, 0, createViewLineTokens([createPart(0, 3)]), [
                new lineDecorations_1.$MW(1, 1, 'before', 1 /* InlineDecorationType.Before */),
                new lineDecorations_1.$MW(1, 1, 'after', 2 /* InlineDecorationType.After */),
        ...
        test('issue #118759: enable multiple text editor decorations in empty lines', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, '', false, true, false, 0, createViewLineTokens([createPart(0, 3)]), [
                new lineDecorations_1.$MW(1, 1, 'after1', 2 /* InlineDecorationType.After */),
                new lineDecorations_1.$MW(1, 1, 'after2', 2 /* InlineDecorationType.After */),
                new lineDecorations_1.$MW(1, 1, 'before1', 1 /* InlineDecorationType.Before */),
                new lineDecorations_1.$MW(1, 1, 'before2', 1 /* InlineDecorationType.Before */),
            ], 2, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #38935: GitLens end-of-line blame no longer rendering', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, '\t}', false, true, false, 0, createViewLineTokens([createPart(2, 3)]), [
                new lineDecorations_1.$MW(3, 3, 'ced-TextEditorDecorationType2-5e9b9b3f-3 ced-TextEditorDecorationType2-3', 1 /* InlineDecorationType.Before */),
                new lineDecorations_1.$MW(3, 3, 'ced-TextEditorDecorationType2-5e9b9b3f-4 ced-TextEditorDecorationType2-4', 2 /* InlineDecorationType.After */),
        ...
        test('issue #136622: Inline decorations are not rendering on non-ASCII lines when renderControlCharacters is on', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, 'some text £', false, false, false, 0, createViewLineTokens([createPart(11, 3)]), [
                new lineDecorations_1.$MW(5, 5, 'inlineDec1', 2 /* InlineDecorationType.After */),
                new lineDecorations_1.$MW(6, 6, 'inlineDec2', 1 /* InlineDecorationType.Before */),
        ...
        test('issue #22832: Consider fullwidth characters when rendering tabs', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, 'asd = "擦"\t\t#asd', false, false, false, 0, createViewLineTokens([createPart(15, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #22832: Consider fullwidth characters when rendering tabs (render whitespace)', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, 'asd = "擦"\t\t#asd', false, false, false, 0, createViewLineTokens([createPart(15, 3)]), [], 4, 0, 10, 10, 10, 10000, 'all', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #22352: COMBINING ACUTE ACCENT (U+0301)', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, '12345689012345678901234568901234567890123456890abába', false, false, false, 0, createViewLineTokens([createPart(53, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #22352: Partially Broken Complex Script Rendering of Tamil', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, ' JoyShareல் பின்தொடர்ந்து, விடீயோ, ஜோக்குகள், அனிமேசன், நகைச்சுவை படங்கள் மற்றும் செய்திகளை பெறுவீர்', false, false, false, 0, createViewLineTokens([createPart(100, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #42700: Hindi characters are not being rendered properly', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, ' वो ऐसा क्या है जो हमारे अंदर भी है और बाहर भी है। जिसकी वजह से हम सब हैं। जिसने इस सृष्टि की रचना की है।', false, false, false, 0, createViewLineTokens([createPart(105, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #38123: editor.renderWhitespace: "boundary" renders whitespace at line wrap point when line is wrapped', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, true, 'This is a long line which never uses more than two spaces. ', true, true, false, 0, createViewLineTokens([createPart(59, 3)]), [], 4, 0, 10, 10, 10, 10000, 'boundary', false, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #33525: Long line with ligatures takes a long time to paint decorations', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, false, 'append data to append data to append data to append data to append data to append data to append data to append data to append data to append data to append data to append data to append data to', false, true, false, 0, createViewLineTokens([createPart(194, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #33525: Long line with ligatures takes a long time to paint decorations - not possible', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, false, 'appenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatatoappenddatato', false, true, false, 0, createViewLineTokens([createPart(194, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', false, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #91936: Semantic token color highlighting fails on line with selected text', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, '                    else if ($s = 08) then \'\\b\'', false, true, false, 0, createViewLineTokens([
                createPart(20, 1),
                createPart(24, 15),
                createPart(25, 1),
                createPart(27, 15),
                ...
                createPart(43, 1),
                createPart(47, 11)
            ]), [], 4, 0, 10, 11, 11, 10000, 'selection', false, false, [new viewLineRenderer_1.$PW(0, 47)]));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
                    '<span class="mtkz" style="width:10px">\u00b7\u200c</span>',
        ...
        test('issue #119416: Delete Control Character (U+007F / &#127;) displayed as space', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, false, '[' + String.fromCharCode(127) + '] [' + String.fromCharCode(0) + ']', false, true, false, 0, createViewLineTokens([createPart(7, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', true, true, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
                    '<span class="mtk3">[\u2421]\u00a0[\u2400]</span>',
                ],
        ...
        test('issue #116939: Important control characters aren\'t rendered', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, false, `transferBalance(5678,${String.fromCharCode(0x202E)}6776,4321${String.fromCharCode(0x202C)},"USD");`, false, false, false, 0, createViewLineTokens([createPart(42, 3)]), [], 4, 0, 10, 10, 10, 10000, 'none', true, false, null));
            assert.deepStrictEqual(inflateRenderLineOutput(actual), {
                html: [
        ...
        test('issue #124038: Multiple end-of-line text decorations get merged', () => {
            const actual = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(true, false, '    if', false, true, false, 0, createViewLineTokens([createPart(4, 1), createPart(6, 2)]), [
                new lineDecorations_1.$MW(7, 7, 'ced-1-TextEditorDecorationType2-17c14d98-3 ced-1-TextEditorDecorationType2-3', 1 /* InlineDecorationType.Before */),
                new lineDecorations_1.$MW(7, 7, 'ced-1-TextEditorDecorationType2-17c14d98-4 ced-1-TextEditorDecorationType2-4', 2 /* InlineDecorationType.After */),
                new lineDecorations_1.$MW(7, 7, 'ced-ghost-text-1-4', 2 /* InlineDecorationType.After */),
        ...
        function createTestGetColumnOfLinePartOffset(lineContent, tabSize, parts, expectedPartLengths) {
            const renderLineOutput = (0, viewLineRenderer_1.$WW)(new viewLineRenderer_1.$QW(false, true, lineContent, false, true, false, 0, createViewLineTokens(parts), [], tabSize, 0, 10, 10, 10, -1, 'none', false, false, null));
            return (partIndex, partLength, offset, expected) => {
                const actualColumn = renderLineOutput.characterMapping.getColumn(new viewLineRenderer_1.$RW(partIndex, offset), partLength);
