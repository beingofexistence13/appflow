...
define(["require", "exports", "assert", "vs/base/browser/ui/tree/indexTreeModel", "vs/base/common/async", "vs/base/test/common/utils"], function (require, exports, assert, indexTreeModel_1, async_1, utils_1) {
    ...
    suite('IndexTreeModel', () => {
        ...
        test('ctor', () => {
            const list = [];
            const model = new indexTreeModel_1.$aS('test', toList(list), -1);
            assert(model);
        ...
        test('simple filter', () => {
            ...
            const model = new indexTreeModel_1.$aS('test', toList(list), -1, { filter });
            model.splice([0], 0, [
                {
                    element: 0, children: [
                        { element: 1 },
        ...
        test('recursive filter', () => {
            ...
            const model = new indexTreeModel_1.$aS('test', toList(list), 'root', { filter });
            model.splice([0], 0, [
                {
