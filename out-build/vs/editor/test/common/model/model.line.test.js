...
define(["require", "exports", "assert", "vs/base/test/common/utils", "vs/editor/common/core/range", "vs/editor/common/languages", "vs/editor/common/model/utils", "vs/editor/common/tokens/contiguousMultilineTokensBuilder", "vs/editor/common/tokens/lineTokens", "vs/editor/test/common/core/testLineToken", "vs/editor/test/common/testTextModel"], function (require, exports, assert, utils_1, range_1, languages_1, utils_2, contiguousMultilineTokensBuilder_1, lineTokens_1, testLineToken_1, testTextModel_1) {
    ...
    function assertLineTokens(__actual, _expected) {
        ...
        lineTokens_1.$Xs.convertToEndOffset(tmp, __actual.getLineContent().length);
        const expected = testLineToken_1.$k$b.inflateArr(tmp);
    ...
    suite('ModelLine - getIndentLevel', () => {
        ...
        function assertIndentLevel(text, expected, tabSize = 4) {
            const actual = (0, utils_2.$XB)(text, tabSize);
    ...
    class ManualTokenizationSupport {
        ...
        tokenizeEncoded(line, hasEOL, state) {
            const s = state;
            return new languages_1.$6s(this.a.get(s.lineNumber), new LineState(s.lineNumber + 1));
        }
        /**
    ...
    suite('ModelLinesTokens', () => {
        ...
        function testApplyEdits(initial, edits, expected) {
            ...
            const d = languages_1.$bt.register('test', s);
            const model = (0, testTextModel_1.$O0b)(initialText, 'test');
            ...
            for (let lineIndex = 0; lineIndex < initial.length; lineIndex++) {
                ...
                lineTokens_1.$Xs.convertToEndOffset(tokens, lineTextLength);
        ...
        test('single delete 1', () => {
            testApplyEdits([{
                ...
                }], [{ range: new range_1.$ks(1, 1, 1, 2), text: '' }], [{
                    text: 'ello world',
        ...
        test('single delete 2', () => {
            testApplyEdits([{
                ...
                }], [{ range: new range_1.$ks(1, 3, 1, 8), text: '' }], [{
                    text: 'herld',
        ...
        test('single delete 3', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 1, 1, 6), text: '' }], [{
                    text: ' world',
        ...
        test('single delete 4', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 2, 1, 7), text: '' }], [{
                    text: 'hworld',
        ...
        test('single delete 5', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 1, 1, 12), text: '' }], [{
                    text: '',
        ...
        test('multi delete 6', () => {
            testApplyEdits([{
                ...
                }], [{ range: new range_1.$ks(1, 6, 3, 6), text: '' }], [{
                    text: 'hello world',
        ...
        test('multi delete 7', () => {
            testApplyEdits([{
                    ...
                    text: 'hello world',
                    tokens: [new TestToken(0, 7), new TestToken(5, 8), new TestToken(6, 9)]
                }], [{ range: new range_1.$ks(1, 12, 3, 12), text: '' }], [{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }]);
        });
        test('multi delete 8', () => {
            testApplyEdits([{
                    ...
                    text: 'hello world',
                    tokens: [new TestToken(0, 7), new TestToken(5, 8), new TestToken(6, 9)]
                }], [{ range: new range_1.$ks(1, 1, 3, 1), text: '' }], [{
                    text: 'hello world',
                    tokens: [new TestToken(0, 7), new TestToken(5, 8), new TestToken(6, 9)]
                }]);
        });
        test('multi delete 9', () => {
            testApplyEdits([{
                    ...
                    text: 'hello world',
                    tokens: [new TestToken(0, 7), new TestToken(5, 8), new TestToken(6, 9)]
                }], [{ range: new range_1.$ks(1, 12, 3, 1), text: '' }], [{
        ...
        test('single insert 1', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 1, 1, 1), text: 'xx' }], [{
                    text: 'xxhello world',
        ...
        test('single insert 2', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 2, 1, 2), text: 'xx' }], [{
                    text: 'hxxello world',
                    tokens: [new TestToken(0, 1), new TestToken(7, 2), new TestToken(8, 3)]
                }]);
        });
        test('single insert 3', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 6, 1, 6), text: 'xx' }], [{
                    text: 'helloxx world',
                    tokens: [new TestToken(0, 1), new TestToken(7, 2), new TestToken(8, 3)]
                }]);
        });
        test('single insert 4', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 7, 1, 7), text: 'xx' }], [{
                    text: 'hello xxworld',
        ...
        test('single insert 5', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 12, 1, 12), text: 'xx' }], [{
                    text: 'hello worldxx',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }]);
        });
        ...
        test('multi insert 7', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 12, 1, 12), text: '\n' }], [{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }, {
                    text: '',
        ...
        test('multi insert 8', () => {
            testApplyEdits([{
                    text: 'hello world',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2), new TestToken(6, 3)]
                }], [{ range: new range_1.$ks(1, 7, 1, 7), text: '\n' }], [{
                    text: 'hello ',
                    tokens: [new TestToken(0, 1), new TestToken(5, 2)]
                }, {
                    text: 'world',
        ...
        function testLineEditTokens(initialText, initialTokens, edits, expectedText, expectedTokens) {
            testApplyEdits([{
                ...
                range: new range_1.$ks(1, ed.startColumn, 1, ed.endColumn),
                text: ed.text
            })), [{
                    text: expectedText,
        ...
        test('insertion on empty line', () => {
            const s = new ManualTokenizationSupport();
            const d = languages_1.$bt.register('test', s);
            const model = (0, testTextModel_1.$O0b)('some text', 'test');
            const tokens = TestToken.toTokens([new TestToken(0, 1)]);
            lineTokens_1.$Xs.convertToEndOffset(tokens, model.getLineMaxColumn(1) - 1);
            s.setLineTokens(1, tokens);
            model.applyEdits([{
                    range: new range_1.$ks(1, 1, 1, 10),
                    text: ''
                }]);
        ...
        function testLineSplitTokens(initialText, initialTokens, splitColumn, expectedText1, expectedText2, expectedTokens) {
            testApplyEdits([{
                    ...
                    range: new range_1.$ks(1, splitColumn, 1, splitColumn),
                    text: '\n'
                }], [{
                    text: expectedText1,
                    tokens: expectedTokens
        ...
        function testLineAppendTokens(aText, aTokens, bText, bTokens, expectedText, expectedTokens) {
            testApplyEdits([{
                    ...
                    range: new range_1.$ks(1, aText.length + 1, 2, 1),
                    text: ''
                }], [{
                    text: expectedText,
                    tokens: expectedTokens
