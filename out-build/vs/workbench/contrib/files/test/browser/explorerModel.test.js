...
define(["require", "exports", "assert", "vs/base/common/platform", "vs/base/common/uri", "vs/base/common/path", "vs/workbench/contrib/files/browser/fileActions", "vs/workbench/contrib/files/common/explorerModel", "vs/base/test/common/utils", "vs/workbench/test/browser/workbenchTestServices", "vs/platform/configuration/test/common/testConfigurationService", "vs/workbench/test/common/workbenchTestServices"], function (require, exports, assert, platform_1, uri_1, path_1, fileActions_1, explorerModel_1, utils_1, workbenchTestServices_1, testConfigurationService_1, workbenchTestServices_2) {
    ...
    suite('Files - View Model', function () {
        ...
        function createStat(path, name, isFolder, hasChildren, size, mtime) {
            return new explorerModel_1.$vHb(utils_1.$0S.call(this, path), fileService, configService, workbenchTestServices_2.$dec, undefined, isFolder, false, false, false, name, mtime);
        }
        const pathService = new workbenchTestServices_1.$5ec();
        test('Properties', function () {
            const d = new Date().getTime();
            let s = createStat.call(this, '/path/to/stat', 'sName', true, true, 8096, d);
            assert.strictEqual(s.isDirectoryResolved, false);
            assert.strictEqual(s.resource.fsPath, utils_1.$0S.call(this, '/path/to/stat').fsPath);
        ...
        test('Add and Remove Child, check for hasChild', function () {
            ...
            s.addChild(child4);
            assert.strictEqual(child4.resource.fsPath, utils_1.$0S.call(this, '/path/to/stat/' + child4.name).fsPath);
        });
        test('Move', function () {
            const d = new Date().getTime();
            ...
            assert.strictEqual(s4.resource.fsPath, utils_1.$0S.call(this, '/' + s4.name).fsPath);
        ...
        test('Rename', function () {
            ...
            assert.strictEqual(s3.resource.fsPath, utils_1.$0S.call(this, '/otherpath/to').fsPath);
            assert.strictEqual(s4.resource.fsPath, utils_1.$0S.call(this, '/otherpath/to/stat').fsPath);
        ...
        test('Find', function () {
            ...
            assert.strictEqual(s1.find(utils_1.$0S.call(this, 'foobar')), null);
            assert.strictEqual(s1.find(utils_1.$0S.call(this, '/')), s1);
        });
        test('Find with mixed case', function () {
            ...
            s4.addChild(child1);
            child1.addChild(child2);
            if (platform_1.$k) { // linux is case sensitive
                assert.ok(!s1.find(utils_1.$0S.call(this, '/path/to/stat/Foo')));
                assert.ok(!s1.find(utils_1.$0S.call(this, '/Path/to/stat/foo/bar.html')));
            }
            else {
                assert.ok(s1.find(utils_1.$0S.call(this, '/path/to/stat/Foo')));
                assert.ok(s1.find(utils_1.$0S.call(this, '/Path/to/stat/foo/bar.html')));
        ...
        test('Validate File Name (For Create)', function () {
            ...
            s.addChild(sChild);
            assert((0, fileActions_1.$3Hb)(pathService, s, null, platform_1.OS) !== null);
            assert((0, fileActions_1.$3Hb)(pathService, s, '', platform_1.OS) !== null);
            assert((0, fileActions_1.$3Hb)(pathService, s, '  ', platform_1.OS) !== null);
            assert((0, fileActions_1.$3Hb)(pathService, s, 'Read Me', platform_1.OS) === null, 'name containing space');
            if (platform_1.$i) {
                assert((0, fileActions_1.$3Hb)(pathService, s, 'foo:bar', platform_1.OS) !== null);
                assert((0, fileActions_1.$3Hb)(pathService, s, 'foo*bar', platform_1.OS) !== null);
                assert((0, fileActions_1.$3Hb)(pathService, s, 'foo?bar', platform_1.OS) !== null);
                assert((0, fileActions_1.$3Hb)(pathService, s, 'foo<bar', platform_1.OS) !== null);
                assert((0, fileActions_1.$3Hb)(pathService, s, 'foo>bar', platform_1.OS) !== null);
            ...
            assert((0, fileActions_1.$3Hb)(pathService, s, 'alles.klar', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, s, '.foo', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, s, 'foo.bar', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, s, 'foo', platform_1.OS) === null);
        });
        ...
        test('Validate Multi-Path File Names', function () {
            ...
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, 'foo/bar', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, 'foo\\bar', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, 'all/slashes/are/same', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, 'theres/one/different\\slash', platform_1.OS) === null);
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, '/slashAtBeginning', platform_1.OS) !== null);
            ...
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, '/path/to/stat/fileNested/aChild', platform_1.OS) !== null);
            // detect if path already exists
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, '/path/to/stat/fileNested', platform_1.OS) !== null);
            assert((0, fileActions_1.$3Hb)(pathService, wsFolder, '/path/to/stat/', platform_1.OS) !== null);
        });
        test('Merge Local with Disk', function () {
            const merge1 = new explorerModel_1.$vHb(uri_1.URI.file((0, path_1.$9d)('C:\\', '/path/to')), fileService, configService, workbenchTestServices_2.$dec, undefined, true, false, false, false, 'to', Date.now());
            const merge2 = new explorerModel_1.$vHb(uri_1.URI.file((0, path_1.$9d)('C:\\', '/path/to')), fileService, configService, workbenchTestServices_2.$dec, undefined, true, false, false, false, 'to', Date.now());
            // Merge Properties
            explorerModel_1.$vHb.mergeLocalWithDisk(merge2, merge1);
            assert.strictEqual(merge1.mtime, merge2.mtime);
            // Merge Child when isDirectoryResolved=false is a no-op
            merge2.addChild(new explorerModel_1.$vHb(uri_1.URI.file((0, path_1.$9d)('C:\\', '/path/to/foo.html')), fileService, configService, workbenchTestServices_2.$dec, undefined, true, false, false, false, 'foo.html', Date.now()));
            explorerModel_1.$vHb.mergeLocalWithDisk(merge2, merge1);
            // Merge Child with isDirectoryResolved=true
            const child = new explorerModel_1.$vHb(uri_1.URI.file((0, path_1.$9d)('C:\\', '/path/to/foo.html')), fileService, configService, workbenchTestServices_2.$dec, undefined, true, false, false, false, 'foo.html', Date.now());
