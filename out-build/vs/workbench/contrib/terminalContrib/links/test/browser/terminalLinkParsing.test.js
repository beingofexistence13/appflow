    ...
    suite('TerminalLinkParsing', () => {
        ...
        suite('removeLinkSuffix', () => {
            for (const testLink of testLinks) {
                test('`' + testLink.link + '`', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Ukb)(testLink.link), testLink.suffix === undefined ? testLink.link : testLink.link.replace(testLink.suffix, ''));
                });
            }
        });
        suite('getLinkSuffix', () => {
            for (const testLink of testLinks) {
                test('`' + testLink.link + '`', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Xkb)(testLink.link), testLink.suffix === undefined ? null : {
        ...
        suite('detectLinkSuffixes', () => {
            for (const testLink of testLinks) {
                test('`' + testLink.link + '`', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Wkb)(testLink.link), testLink.suffix === undefined ? [] : [{
                            row: testLink.hasRow ? testRow : undefined,
                            col: testLink.hasCol ? testCol : undefined,
                            rowEnd: testLink.hasRowEnd ? testRowEnd : undefined,
                            colEnd: testLink.hasColEnd ? testColEnd : undefined,
            ...
            test('foo(1, 2) bar[3, 4] baz on line 5', () => {
                (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Wkb)('foo(1, 2) bar[3, 4] baz on line 5'), [
                    {
                        col: 2,
                        row: 1,
                        rowEnd: undefined,
        ...
        suite('removeLinkQueryString', () => {
            test('should remove any query string from the link', () => {
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('?a=b'), '');
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('foo?a=b'), 'foo');
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('./foo?a=b'), './foo');
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('/foo/bar?a=b'), '/foo/bar');
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('foo?a=b?'), 'foo');
                (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Vkb)('foo?a=b&c=d'), 'foo');
            });
        ...
        suite('detectLinks', () => {
            test('foo(1, 2) bar[3, 4] "baz" on line 5', () => {
                (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('foo(1, 2) bar[3, 4] "baz" on line 5', 3 /* OperatingSystem.Linux */), [
                    {
                        path: {
                            index: 0,
                            text: 'foo'
            ...
            test('should extract the link prefix', () => {
                (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('"foo", line 5, col 6', 3 /* OperatingSystem.Linux */), [
                    {
                        path: {
                            index: 1,
                            text: 'foo'
            ...
            test('should be smart about determining the link prefix when multiple prefix characters exist', () => {
                (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('echo \'"foo", line 5, col 6\'', 3 /* OperatingSystem.Linux */), [
                    {
                        path: {
                            index: 7,
                            text: 'foo'
            ...
            test('should detect both suffix and non-suffix links on a single line', () => {
                (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('PS C:\\Github\\microsoft\\vscode> echo \'"foo", line 5, col 6\'', 1 /* OperatingSystem.Windows */), [
                    {
                        path: {
                            index: 3,
            ...
            suite('"|"', () => {
                test('should exclude pipe characters from link paths', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('|C:\\Github\\microsoft\\vscode|', 1 /* OperatingSystem.Windows */), [
                        {
                            path: {
                                index: 1,
                                text: 'C:\\Github\\microsoft\\vscode'
                ...
                test('should exclude pipe characters from link paths with suffixes', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('|C:\\Github\\microsoft\\vscode:400|', 1 /* OperatingSystem.Windows */), [
                        {
                            path: {
                                index: 1,
                                text: 'C:\\Github\\microsoft\\vscode'
            ...
            suite('"<>"', () => {
                for (const os of operatingSystems) {
                    test(`should exclude bracket characters from link paths ${osLabel[os]}`, () => {
                        (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)(`<${osTestPath[os]}<`, os), [
                            {
                                path: {
                                    index: 1,
                                    text: osTestPath[os]
                    ...
                    test(`should exclude bracket characters from link paths with suffixes ${osLabel[os]}`, () => {
                        (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)(`<${osTestPath[os]}:400<`, os), [
                            {
                                path: {
                                    index: 1,
                                    text: osTestPath[os]
            ...
            suite('query strings', () => {
                for (const os of operatingSystems) {
                    test(`should exclude query strings from link paths ${osLabel[os]}`, () => {
                        (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)(`${osTestPath[os]}?a=b`, os), [
                            {
                                path: {
                                    index: 0,
                                    text: osTestPath[os]
                        ...
                        (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)(`${osTestPath[os]}?a=b&c=d`, os), [
                            {
                                path: {
                                    index: 0,
                                    text: osTestPath[os]
            ...
            suite('should detect file names in git diffs', () => {
                test('--- a/foo/bar', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('--- a/foo/bar', 3 /* OperatingSystem.Linux */), [
                        {
                            path: {
                                index: 6,
                                text: 'foo/bar'
                ...
                test('+++ b/foo/bar', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('+++ b/foo/bar', 3 /* OperatingSystem.Linux */), [
                        {
                            path: {
                                index: 6,
                                text: 'foo/bar'
                ...
                test('diff --git a/foo/bar b/foo/baz', () => {
                    (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)('diff --git a/foo/bar b/foo/baz', 3 /* OperatingSystem.Linux */), [
                        {
                            path: {
                                index: 13,
                                text: 'foo/bar'
            ...
            suite('should detect 3 suffix links on a single line', () => {
                for (let i = 0; i < testLinksWithSuffix.length - 2; i++) {
                    ...
                    test('`' + line.replaceAll('\u00A0', '<nbsp>') + '`', () => {
                        (0, assert_1.strictEqual)((0, terminalLinkParsing_1.$Zkb)(line, 3 /* OperatingSystem.Linux */).length, 3);
                        ...
                        (0, assert_1.deepStrictEqual)((0, terminalLinkParsing_1.$Zkb)(line, 3 /* OperatingSystem.Linux */), [detectedLink1, detectedLink2, detectedLink3]);
                    });
                }
            });
        });
