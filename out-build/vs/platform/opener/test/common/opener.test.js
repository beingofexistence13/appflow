...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/platform/opener/common/opener"], function (require, exports, assert, uri_1, opener_1) {
    ...
    suite('extractSelection', () => {
        test('extractSelection with only startLineNumber', async () => {
            ...
            assert.deepStrictEqual((0, opener_1.$RT)(uri).selection, { startLineNumber: 73, startColumn: 1, endLineNumber: undefined, endColumn: undefined });
        });
        ...
        test('extractSelection with startLineNumber and startColumn', async () => {
            ...
            assert.deepStrictEqual((0, opener_1.$RT)(uri).selection, { startLineNumber: 73, startColumn: 84, endLineNumber: undefined, endColumn: undefined });
        });
        ...
        test('extractSelection with range and no column number', async () => {
            ...
            assert.deepStrictEqual((0, opener_1.$RT)(uri).selection, { startLineNumber: 73, startColumn: 1, endLineNumber: 83, endColumn: 1 });
        });
        ...
        test('extractSelection with complete range', async () => {
            ...
            assert.deepStrictEqual((0, opener_1.$RT)(uri).selection, { startLineNumber: 73, startColumn: 84, endLineNumber: 83, endColumn: 52 });
        });
        ...
        test('withSelection with startLineNumber and startColumn', async () => {
            assert.deepStrictEqual((0, opener_1.$QT)(uri_1.URI.parse('file:///some/file.js'), { startLineNumber: 73, startColumn: 84 }).toString(), 'file:///some/file.js#73%2C84');
        });
        test('withSelection with startLineNumber, startColumn and endLineNumber', async () => {
            assert.deepStrictEqual((0, opener_1.$QT)(uri_1.URI.parse('file:///some/file.js'), { startLineNumber: 73, startColumn: 84, endLineNumber: 83 }).toString(), 'file:///some/file.js#73%2C84-83');
        });
        test('withSelection with startLineNumber, startColumn and endLineNumber, endColumn', async () => {
            assert.deepStrictEqual((0, opener_1.$QT)(uri_1.URI.parse('file:///some/file.js'), { startLineNumber: 73, startColumn: 84, endLineNumber: 83, endColumn: 52 }).toString(), 'file:///some/file.js#73%2C84-83%2C52');
        });
        test('extractSelection returns original withSelection URI', async () => {
            let uri = uri_1.URI.parse('file:///some/file.js');
            const uriWithSelection = (0, opener_1.$QT)(uri_1.URI.parse('file:///some/file.js'), { startLineNumber: 73, startColumn: 84, endLineNumber: 83, endColumn: 52 });
            assert.strictEqual(uri.toString(), (0, opener_1.$RT)(uriWithSelection).uri.toString());
            uri = uri_1.URI.parse('file:///some/file.js');
            assert.strictEqual(uri.toString(), (0, opener_1.$RT)(uri).uri.toString());
        });
    });
});
