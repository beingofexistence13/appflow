...
define(["require", "exports", "assert", "vs/base/common/lifecycle", "vs/base/test/common/utils", "vs/editor/browser/coreCommands", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/languages", "vs/editor/common/languages/language", "vs/editor/common/languages/languageConfiguration", "vs/editor/common/languages/languageConfigurationRegistry", "vs/editor/common/languages/nullTokenize", "vs/editor/common/model/textModel", "vs/editor/test/browser/testCodeEditor", "vs/editor/test/common/modes/supports/javascriptOnEnterRules", "vs/editor/test/common/testTextModel"], function (require, exports, assert, lifecycle_1, utils_1, coreCommands_1, editOperation_1, position_1, range_1, selection_1, languages_1, language_1, languageConfiguration_1, languageConfigurationRegistry_1, nullTokenize_1, textModel_1, testCodeEditor_1, javascriptOnEnterRules_1, testTextModel_1) {
    ...
    function moveTo(editor, viewModel, lineNumber, column, inSelectionMode = false) {
        if (inSelectionMode) {
            coreCommands_1.CoreNavigationCommands.MoveToSelect.runCoreEditorCommand(viewModel, {
                position: new position_1.$js(lineNumber, column)
            });
        }
        else {
    ...
    function assertCursor(viewModel, what) {
        let selections;
        if (what instanceof position_1.$js) {
            selections = [new selection_1.$ms(what.lineNumber, what.column, what.lineNumber, what.column)];
        }
        else if (what instanceof selection_1.$ms) {
            selections = [what];
        }
        else {
            selections = what;
    ...
    suite('Editor Controller - Cursor', () => {
        ...
        test('cursor initialized', () => {
            runTest((editor, viewModel) => {
                assertCursor(viewModel, new position_1.$js(1, 1));
            });
        });
        // --------- absolute move
        test('no move', () => {
        ...
        test('move', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, 2));
            });
        });
        test('move in selection mode', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 1, 2, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 1, 2));
            });
        });
        test('move beyond line end', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 1, 25);
                assertCursor(viewModel, new position_1.$js(1, LINE1.length + 1));
            });
        });
        test('move empty line', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 4, 20);
                assertCursor(viewModel, new position_1.$js(4, 1));
            });
        });
        test('move one char line', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 5, 20);
                assertCursor(viewModel, new position_1.$js(5, 2));
            });
        });
        test('selection down', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 2, 1, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 2, 1));
            });
        });
        test('move and then select', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 2, 3);
                assertCursor(viewModel, new position_1.$js(2, 3));
                moveTo(editor, viewModel, 2, 15, true);
                assertCursor(viewModel, new selection_1.$ms(2, 3, 2, 15));
                moveTo(editor, viewModel, 1, 2, true);
                assertCursor(viewModel, new selection_1.$ms(2, 3, 1, 2));
            });
        });
        // --------- move left
        ...
        test('move left', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, 3));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(1, 2));
            });
        });
        test('move left with surrogate pair', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(3, 17));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 15));
            });
        });
        test('move left goes to previous row', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 2, 1);
                assertCursor(viewModel, new position_1.$js(2, 1));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(1, 21));
            });
        });
        test('move left selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 1, 1, 21));
            });
        });
        // --------- move right
        ...
        test('move right', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, 3));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(1, 4));
            });
        });
        ...
        test('move right selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 21, 2, 1));
            });
        });
        // --------- move down
        test('move down', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(2, 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(4, 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(5, 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(5, 2));
            });
        });
        test('move down with selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 1, 2, 1));
                moveDown(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 3, 1));
                moveDown(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 4, 1));
                moveDown(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 5, 1));
                moveDown(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 5, 2));
            });
        });
        test('move down with tabs', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 1, 5);
                assertCursor(viewModel, new position_1.$js(1, 5));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, 2));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 5));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(4, 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(5, 2));
        ...
        test('move up with selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 5, 2, 2));
                moveUp(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(3, 5, 1, 5));
            });
        });
        ...
        test('move up and down with end of lines starting from a long one', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, LINE1.length + 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, LINE2.length + 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, LINE3.length + 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(4, LINE4.length + 1));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(5, LINE5.length + 1));
                moveUp(editor, viewModel);
                moveUp(editor, viewModel);
                moveUp(editor, viewModel);
                moveUp(editor, viewModel);
        ...
        test('issue #44465: cursor position not correct when move', () => {
            runTest((editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(1, 5, 1, 5)]);
        ...
        test('issue #144041: Cursor up/down works', () => {
            ...
            (0, testCodeEditor_1.$X0b)(model, { wrappingIndent: 'indent', wordWrap: 'wordWrapColumn', wordWrapColumn: 20 }, (editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(1, 1, 1, 1)]);
            ...
            (0, testCodeEditor_1.$X0b)(model, { wrappingIndent: 'indent', wordWrap: 'wordWrapColumn', wordWrapColumn: 20 }, (editor, viewModel) => {
                editor.changeDecorations((changeAccessor) => {
                    changeAccessor.deltaDecorations([], [
                        {
                            range: new range_1.$ks(1, 22, 1, 22),
                            options: {
        ...
        test('move to beginning of line', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, 6));
                moveToBeginningOfLine(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(1, 1));
            });
        });
        ...
        test('move to beginning of line from within line selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 8, 1, 6));
                moveToBeginningOfLine(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 8, 1, 1));
            });
        });
        test('move to beginning of line with selection multiline forward', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 5, 3, 5));
            });
        });
        test('move to beginning of line with selection multiline backward', () => {
            runTest((editor, viewModel) => {
                ...
                moveToBeginningOfLine(editor, viewModel, false);
                assertCursor(viewModel, new selection_1.$ms(1, 6, 1, 6));
            });
        });
        ...
        test('issue #17011: Shift+home/end now go to the end of the selection start\'s line, not the selection\'s end', () => {
            runTest((editor, viewModel) => {
                ...
                moveTo(editor, viewModel, 3, 9, true);
                moveToBeginningOfLine(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 8, 3, 5));
            });
        });
        // --------- move to end of line
        ...
        test('move to end of line from within line selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 6, 1, LINE1.length + 1));
                moveToEndOfLine(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(1, 6, 1, LINE1.length + 1));
            });
        });
        test('move to end of line with selection multiline forward', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 17, 3, 17));
            });
        });
        test('move to end of line with selection multiline backward', () => {
            runTest((editor, viewModel) => {
                ...
                moveToEndOfLine(editor, viewModel, false);
                assertCursor(viewModel, new selection_1.$ms(1, 21, 1, 21));
            });
        });
        ...
        test('move to beginning of buffer from within first line selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 3, 1, 1));
            });
        });
        test('move to beginning of buffer from within another line selection', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 3, 3);
                moveToBeginningOfBuffer(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(3, 3, 1, 1));
            });
        });
        ...
        test('move to end of buffer from within last line selection', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(5, 1, 5, LINE5.length + 1));
            });
        });
        test('move to end of buffer from within another line selection', () => {
            runTest((editor, viewModel) => {
                moveTo(editor, viewModel, 3, 3);
                moveToEndOfBuffer(editor, viewModel, true);
                assertCursor(viewModel, new selection_1.$ms(3, 3, 5, LINE5.length + 1));
            });
        });
        // --------- misc
        test('select all', () => {
            runTest((editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 1, 5, LINE5.length + 1));
            });
        });
        // --------- eventing
            ...
            runTest((editor, viewModel) => {
                ...
                const disposable = viewModel.onEvent((e) => {
                    if (e.kind === 6 /* OutgoingViewModelEventKind.CursorStateChanged */) {
                        events++;
                        assert.deepStrictEqual(e.selections, [new selection_1.$ms(1, 2, 1, 2)]);
                    }
                });
                moveTo(editor, viewModel, 1, 2);
        ...
        test('move in selection mode eventing', () => {
            runTest((editor, viewModel) => {
                ...
                const disposable = viewModel.onEvent((e) => {
                    if (e.kind === 6 /* OutgoingViewModelEventKind.CursorStateChanged */) {
                        events++;
                        assert.deepStrictEqual(e.selections, [new selection_1.$ms(1, 1, 1, 2)]);
                    }
                });
                moveTo(editor, viewModel, 1, 2, true);
                assert.strictEqual(events, 1, 'receives 1 event');
        ...
        test('Independent model edit 1', () => {
            runTest((editor, viewModel) => {
                ...
                editor.getModel().applyEdits([editOperation_1.$ls.delete(new range_1.$ks(2, 1, 2, 2))]);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 2, 15));
            });
        });
        test('column select 1', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                assertCursor(viewModel, new position_1.$js(1, 7));
                coreCommands_1.CoreNavigationCommands.ColumnSelect.runCoreEditorCommand(viewModel, {
                    position: new position_1.$js(4, 4),
                    viewPosition: new position_1.$js(4, 4),
                    mouseColumn: 15,
                    doColumnSelect: true
                });
                const expectedSelections = [
                    new selection_1.$ms(1, 7, 1, 12),
                    new selection_1.$ms(2, 4, 2, 9),
                    new selection_1.$ms(3, 3, 3, 6),
                    new selection_1.$ms(4, 4, 4, 4),
                ];
        ...
        test('grapheme breaking', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                viewModel.setSelections('test', [new selection_1.$ms(2, 1, 2, 1)]);
                moveRight(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, 3));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, 1));
                viewModel.setSelections('test', [new selection_1.$ms(3, 1, 3, 1)]);
                moveRight(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 4));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 1));
                viewModel.setSelections('test', [new selection_1.$ms(4, 1, 4, 1)]);
                moveRight(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(4, 3));
                moveLeft(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(4, 1));
                viewModel.setSelections('test', [new selection_1.$ms(1, 3, 1, 3)]);
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, 5));
                moveDown(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(3, 4));
                moveUp(editor, viewModel);
                assertCursor(viewModel, new position_1.$js(2, 5));
        ...
        test('issue #4905 - column select is biased to the right', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                assertCursor(viewModel, new position_1.$js(1, 4));
                coreCommands_1.CoreNavigationCommands.ColumnSelect.runCoreEditorCommand(viewModel, {
                    position: new position_1.$js(4, 1),
                    viewPosition: new position_1.$js(4, 1),
                    mouseColumn: 1,
                    doColumnSelect: true
                });
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(3, 4, 3, 1),
                    new selection_1.$ms(4, 4, 4, 1),
                ]);
            });
        });
        test('issue #20087: column select with mouse', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                assertCursor(viewModel, new position_1.$js(10, 10));
                coreCommands_1.CoreNavigationCommands.ColumnSelect.runCoreEditorCommand(viewModel, {
                    position: new position_1.$js(1, 1),
                    viewPosition: new position_1.$js(1, 1),
                    mouseColumn: 1,
                    doColumnSelect: true
                });
                assertCursor(viewModel, [
                    new selection_1.$ms(10, 10, 10, 1),
                    new selection_1.$ms(9, 10, 9, 1),
                    new selection_1.$ms(8, 10, 8, 1),
                    new selection_1.$ms(7, 10, 7, 1),
                    new selection_1.$ms(6, 10, 6, 1),
                    new selection_1.$ms(5, 10, 5, 1),
                    new selection_1.$ms(4, 10, 4, 1),
                    new selection_1.$ms(3, 10, 3, 1),
                    new selection_1.$ms(2, 10, 2, 1),
        ...
        test('issue #20087: column select with keyboard', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                assertCursor(viewModel, [
                    new selection_1.$ms(10, 10, 10, 9)
                ]);
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectLeft.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(10, 10, 10, 8)
                ]);
        ...
        test('column select with keyboard', () => {
            (0, testCodeEditor_1.$X0b)([
                ...
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 5),
                    new selection_1.$ms(2, 4, 2, 5)
                ]);
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectDown.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 5),
                    new selection_1.$ms(2, 4, 2, 5),
                    new selection_1.$ms(3, 4, 3, 5),
                ]);
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectDown.runCoreEditorCommand(viewModel, {});
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectDown.runCoreEditorCommand(viewModel, {});
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectDown.runCoreEditorCommand(viewModel, {});
                ...
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(2, 4, 2, 5),
                    new selection_1.$ms(3, 4, 3, 5),
                    new selection_1.$ms(4, 4, 4, 5),
                    new selection_1.$ms(5, 4, 5, 5),
                    new selection_1.$ms(6, 4, 6, 5),
                    new selection_1.$ms(7, 4, 7, 5),
                ]);
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 6),
                    new selection_1.$ms(2, 4, 2, 6),
                    new selection_1.$ms(3, 4, 3, 6),
                    new selection_1.$ms(4, 4, 4, 6),
                    new selection_1.$ms(5, 4, 5, 6),
                    new selection_1.$ms(6, 4, 6, 6),
                    new selection_1.$ms(7, 4, 7, 6),
                ]);
                // 10 times
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                ...
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 16),
                    new selection_1.$ms(2, 4, 2, 16),
                    new selection_1.$ms(3, 4, 3, 16),
                    new selection_1.$ms(4, 4, 4, 16),
                    new selection_1.$ms(5, 4, 5, 16),
                    new selection_1.$ms(6, 4, 6, 16),
                    new selection_1.$ms(7, 4, 7, 16),
                ]);
                // 10 times
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                ...
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 26),
                    new selection_1.$ms(2, 4, 2, 26),
                    new selection_1.$ms(3, 4, 3, 26),
                    new selection_1.$ms(4, 4, 4, 26),
                    new selection_1.$ms(5, 4, 5, 26),
                    new selection_1.$ms(6, 4, 6, 26),
                    new selection_1.$ms(7, 4, 7, 26),
                ]);
                // 2 times => reaching the ending of lines 1 and 2
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                coreCommands_1.CoreNavigationCommands.CursorColumnSelectRight.runCoreEditorCommand(viewModel, {});
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 28),
                    new selection_1.$ms(2, 4, 2, 28),
                    new selection_1.$ms(3, 4, 3, 28),
                    new selection_1.$ms(4, 4, 4, 28),
                    new selection_1.$ms(5, 4, 5, 28),
                    new selection_1.$ms(6, 4, 6, 28),
                    new selection_1.$ms(7, 4, 7, 28),
                ]);
                ...
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 4, 1, 28),
                    new selection_1.$ms(2, 4, 2, 28),
                    new selection_1.$ms(3, 4, 3, 32),
                    new selection_1.$ms(4, 4, 4, 32),
                    new selection_1.$ms(5, 4, 5, 32),
                    new selection_1.$ms(6, 4, 6, 32),
                    new selection_1.$ms(7, 4, 7, 32),
                ]);
                ...
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(2, 4, 2, 28),
                    new selection_1.$ms(3, 4, 3, 32),
                    new selection_1.$ms(4, 4, 4, 34),
                    new selection_1.$ms(5, 4, 5, 34),
                    new selection_1.$ms(6, 4, 6, 34),
                    new selection_1.$ms(7, 4, 7, 34),
                ]);
                ...
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(3, 4, 3, 32),
                    new selection_1.$ms(4, 4, 4, 34),
                    new selection_1.$ms(5, 4, 5, 35),
                    new selection_1.$ms(6, 4, 6, 35),
                    new selection_1.$ms(7, 4, 7, 35),
                ]);
                ...
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(3, 4, 3, 32),
                    new selection_1.$ms(4, 4, 4, 34),
                    new selection_1.$ms(5, 4, 5, 37),
                    new selection_1.$ms(6, 4, 6, 37),
                    new selection_1.$ms(7, 4, 7, 35),
                ]);
                ...
                assertCursor(viewModel, [
                    ...
                    new selection_1.$ms(3, 4, 3, 32),
                    new selection_1.$ms(4, 4, 4, 34),
                    new selection_1.$ms(5, 4, 5, 36),
                    new selection_1.$ms(6, 4, 6, 36),
                    new selection_1.$ms(7, 4, 7, 35),
                ]);
            });
        });
        test('setSelection / setPosition with source', () => {
            const tokenizationSupport = {
                ...
                tokenizeEncoded: (line, hasEOL, state) => {
                    return new languages_1.$6s(new Uint32Array(0), state);
                }
            };
            const LANGUAGE_ID = 'modelModeTest1';
            const languageRegistration = languages_1.$bt.register(LANGUAGE_ID, tokenizationSupport);
            const model = (0, testTextModel_1.$O0b)('Just text', LANGUAGE_ID);
            (0, testCodeEditor_1.$X0b)(model, {}, (editor1, cursor1) => {
                let event = undefined;
                const disposable = editor1.onDidChangeCursorPosition(e => {
                    event = e;
                });
                editor1.setSelection(new range_1.$ks(1, 2, 1, 3), 'navigation');
                assert.strictEqual(event.source, 'navigation');
                event = undefined;
                editor1.setPosition(new position_1.$js(1, 2), 'navigation');
                assert.strictEqual(event.source, 'navigation');
                disposable.dispose();
            });
    ...
    suite('Editor Controller', () => {
        ...
        function setupAutoClosingLanguageTokenization() {
            ...
            disposables.add(languages_1.$bt.register(autoClosingLanguageId, {
                ...
                tokenizeEncoded: function (line, hasEOL, _state) {
                    ...
                    return new languages_1.$6s(result, state);
                    function advance() {
        ...
        function createTextModel(text, languageId = null, options = textModel_1.$MC.DEFAULT_CREATION_OPTIONS, uri = null) {
            return disposables.add((0, testTextModel_1.$P0b)(instantiationService, text, languageId, options, uri));
        }
        function withTestCodeEditor(text, options, callback) {
            ...
            const editor = disposables.add((0, testCodeEditor_1.$20b)(instantiationService, model, options));
        ...
        test('issue microsoft/monaco-editor#443: Indentation of a single row deletes selected text in some cases', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(1, 1, 1, 13)]);
                ...
                assert.deepStrictEqual(viewModel.getSelection(), new selection_1.$ms(1, 1, 1, 14));
            });
        });
        ...
        test('issue #46208: Allow empty selections in the undo/redo stack', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(1, 13));
                moveLeft(editor, viewModel);
                moveRight(editor, viewModel);
                model.pushEditOperations([], [editOperation_1.$ls.replaceMove(new range_1.$ks(1, 12, 1, 13), '')], () => []);
                assert.strictEqual(model.getLineContent(1), 'Hello world');
                assertCursor(viewModel, new position_1.$js(1, 12));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(1), 'Hello world ');
                assertCursor(viewModel, new selection_1.$ms(1, 13, 1, 13));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(1), 'Hello world');
                assertCursor(viewModel, new position_1.$js(1, 12));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
        ...
        test('bug #16815:Shift+Tab doesn\'t go back to tabstop', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 5, 1, 5));
            });
        });
        test('Bug #18293:[regression][editor] Can\'t outdent whitespace line', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                moveTo(editor, viewModel, 1, 7, false);
                assertCursor(viewModel, new selection_1.$ms(1, 7, 1, 7));
                coreCommands_1.CoreEditingCommands.Outdent.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(1), '    ');
                assertCursor(viewModel, new selection_1.$ms(1, 5, 1, 5));
            });
        ...
        test('issue #95591: Unindenting moves cursor to beginning of line', () => {
            ...
            withTestCodeEditor(model, { useTabStops: false }, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 9, 1, 9));
                coreCommands_1.CoreEditingCommands.Outdent.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(1), '    ');
                assertCursor(viewModel, new selection_1.$ms(1, 5, 1, 5));
            });
        ...
        test('Bug #16657: [editor] Tab on empty line of zero indentation moves cursor to position (1,1)', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(7, 1, 7, 1));
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(7), '\t');
                assertCursor(viewModel, new selection_1.$ms(7, 2, 7, 2));
            });
        });
        test('bug #16740: [editor] Cut line doesn\'t quite cut the last line', () => {
            ...
            withTestCodeEditor([
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 1, 2, 1));
        ...
        test('Bug #11476: Double bracket surrounding + undo is broken', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 3, 1, 5));
                viewModel.type('(', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(1, 4, 1, 6));
                viewModel.type('(', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(1, 5, 1, 7));
            });
        });
        test('issue #1140: Backspace stops prematurely', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 2, 1, 14));
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assertCursor(viewModel, new selection_1.$ms(1, 14, 1, 14));
                assert.strictEqual(model.getLineCount(), 1);
                assert.strictEqual(model.getLineContent(1), 'function baz(;');
            });
        });
        ...
        test('issue #74722: Pasting whole line does not replace selection', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(2, 6, 2, 9)]);
                viewModel.paste('line1\n', true);
                assert.strictEqual(model.getLineContent(1), 'line1');
        ...
        test('issue #4996: Multiple cursor paste pastes contents of all cursors', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 1, 1, 1), new selection_1.$ms(2, 1, 2, 1)]);
                viewModel.paste('a\nb\nc\nd', false, [
                    'a\nb',
                    'c\nd'
                ]);
        ...
        test('issue #46440: (1) Pasting a multi-line selection pastes entire selection into every insertion point', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 1, 1, 1), new selection_1.$ms(2, 1, 2, 1), new selection_1.$ms(3, 1, 3, 1)]);
                viewModel.paste('a\nb\nc', false, null);
                assert.strictEqual(model.getValue(), [
                    'aline1',
                    'bline2',
        ...
        test('issue #33788: Wrong cursor position when double click to select a word', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                coreCommands_1.CoreNavigationCommands.WordSelect.runCoreEditorCommand(viewModel, { position: new position_1.$js(1, 8) });
                assert.deepStrictEqual(viewModel.getSelection(), new selection_1.$ms(1, 6, 1, 10));
                coreCommands_1.CoreNavigationCommands.WordSelectDrag.runCoreEditorCommand(viewModel, { position: new position_1.$js(1, 8) });
                assert.deepStrictEqual(viewModel.getSelection(), new selection_1.$ms(1, 6, 1, 10));
            });
        });
        test('issue #12887: Double-click highlighting separating white space', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                coreCommands_1.CoreNavigationCommands.WordSelect.runCoreEditorCommand(viewModel, { position: new position_1.$js(1, 5) });
                assert.deepStrictEqual(viewModel.getSelection(), new selection_1.$ms(1, 5, 1, 8));
            });
        });
        ...
        test('issue #23983: Calling model.setEOL does not reset cursor position', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(2, 2, 2, 2)]);
                model.setEOL(0 /* EndOfLineSequence.LF */);
                assertCursor(viewModel, new selection_1.$ms(2, 2, 2, 2));
            });
        });
        test('issue #23983: Calling model.setValue() resets cursor position', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 1, 1, 1));
            });
        });
        test('issue #36740: wordwrap creates an extra step / character at the wrapping point', () => {
            ...
            withTestCodeEditor([
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 7, 1, 7)]);
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 8, 1, 8));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 9, 1, 9));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 10, 1, 10));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 11, 1, 11));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 12, 1, 12));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 13, 1, 13));
        ...
        test('issue #110376: multiple selections with wordwrap behave differently', () => {
            ...
            withTestCodeEditor([
                ...
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 1, 1, 16),
                    new selection_1.$ms(1, 18, 1, 33),
                    new selection_1.$ms(1, 35, 1, 50),
                ]);
                moveLeft(editor, viewModel);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 1, 1, 1),
                    new selection_1.$ms(1, 18, 1, 18),
                    new selection_1.$ms(1, 35, 1, 35),
                ]);
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 1, 1, 16),
                    new selection_1.$ms(1, 18, 1, 33),
                ...
                moveRight(editor, viewModel);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 16, 1, 16),
                    new selection_1.$ms(1, 33, 1, 33),
                    new selection_1.$ms(1, 50, 1, 50),
                ]);
            });
        });
        test('issue #98320: Multi-Cursor, Wrap lines and cursorSelectRight ==> cursors out of sync', () => {
            ...
            withTestCodeEditor([
                ...
                viewModel.setSelections('test', [
                    ...
                    new selection_1.$ms(2, 16, 2, 16),
                    new selection_1.$ms(3, 13, 3, 13),
                    new selection_1.$ms(4, 12, 4, 12),
                ...
                moveRight(editor, viewModel, true);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 13, 1, 14),
                    new selection_1.$ms(2, 16, 2, 17),
                    new selection_1.$ms(3, 13, 3, 14),
                    new selection_1.$ms(4, 12, 4, 13),
                    new selection_1.$ms(5, 6, 5, 7),
                ]);
                moveRight(editor, viewModel, true);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 13, 1, 15),
                    new selection_1.$ms(2, 16, 2, 18),
                    new selection_1.$ms(3, 13, 3, 15),
                    new selection_1.$ms(4, 12, 4, 14),
                    new selection_1.$ms(5, 6, 5, 8),
                ]);
                moveRight(editor, viewModel, true);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 13, 1, 16),
                    new selection_1.$ms(2, 16, 2, 19),
                    new selection_1.$ms(3, 13, 3, 16),
                    new selection_1.$ms(4, 12, 4, 15),
                    new selection_1.$ms(5, 6, 5, 9),
                ]);
                moveRight(editor, viewModel, true);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 13, 1, 17),
                    new selection_1.$ms(2, 16, 2, 20),
                    new selection_1.$ms(3, 13, 3, 17),
                    new selection_1.$ms(4, 12, 4, 16),
                    new selection_1.$ms(5, 6, 5, 10),
                ]);
            });
        });
        test('issue #41573 - delete across multiple lines does not shrink the selection when word wraps', () => {
            withTestCodeEditor([
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 43, 1, 147));
                editor.getModel().applyEdits([{
                        range: new range_1.$ks(1, 1, 1, 43),
                        text: ''
                    }]);
                assertCursor(viewModel, new selection_1.$ms(1, 1, 1, 105));
            });
        });
        test('issue #22717: Moving text cursor cause an incorrect position in Chinese', () => {
            ...
            withTestCodeEditor([
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 5, 1, 5)]);
                moveDown(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(2, 9, 2, 9));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(2, 10, 2, 10));
                moveRight(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(2, 11, 2, 11));
                moveUp(editor, viewModel);
                assertCursor(viewModel, new selection_1.$ms(1, 6, 1, 6));
            });
        });
        test('issue #112301: new stickyTabStops feature interferes with word wrap', () => {
            withTestCodeEditor([
                ...
                viewModel.setSelections('test', [
                    new selection_1.$ms(2, 31, 2, 31)
                ]);
                moveRight(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 32));
                moveRight(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 33));
                moveRight(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 34));
                moveLeft(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 33));
                moveLeft(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 32));
                moveLeft(editor, viewModel, false);
                assertCursor(viewModel, new position_1.$js(2, 31));
            });
        });
        test('issue #44805: Should not be able to undo in readonly editor', () => {
            ...
            withTestCodeEditor(model, { readOnly: true }, (editor, viewModel) => {
                model.pushEditOperations([new selection_1.$ms(1, 1, 1, 1)], [{
        ...
        test('issue #46314: ViewModel is out of sync with Model!', () => {
            ...
            withTestCodeEditor(model, {}, (editor1, cursor1) => {
                withTestCodeEditor(model, {}, (editor2, cursor2) => {
                    ...
                    model.applyEdits([{ range: new range_1.$ks(1, 1, 1, 1), text: '-' }]);
                    disposable.dispose();
                });
            });
            languageRegistration.dispose();
        ...
        test('issue #37967: problem replacing consecutive characters', () => {
            ...
            withTestCodeEditor(model, { multiCursorMergeOverlapping: false }, (editor, viewModel) => {
                editor.setSelections([
                    ...
                    new selection_1.$ms(2, 13, 2, 13),
                ]);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 11, 1, 11),
                    new selection_1.$ms(1, 14, 1, 14),
                    new selection_1.$ms(2, 11, 2, 11),
                    new selection_1.$ms(2, 11, 2, 11),
                ]);
                viewModel.type('\'', 'keyboard');
        ...
        test('issue #99629: Emoji modifiers in text treated separately when using backspace', () => {
            ...
            withTestCodeEditor(model, { useTabStops: false }, (editor, viewModel) => {
                ...
                editor.setSelections([
                    new selection_1.$ms(1, 1 + len, 1, 1 + len)
                ]);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getValue(1 /* EndOfLinePreference.LF */), '');
            });
        ...
        test('issue #105730: move left behaves differently for multiple cursors', () => {
            ...
            withTestCodeEditor(model, {
                ...
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 10, 1, 12),
                    new selection_1.$ms(1, 21, 1, 23),
                    new selection_1.$ms(1, 32, 1, 34)
                ]);
                moveLeft(editor, viewModel, false);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 10, 1, 10),
                    new selection_1.$ms(1, 21, 1, 21),
                    new selection_1.$ms(1, 32, 1, 32)
                ]);
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 10, 1, 12),
                    new selection_1.$ms(1, 21, 1, 23),
                ...
                moveLeft(editor, viewModel, true);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 10, 1, 11),
                    new selection_1.$ms(1, 21, 1, 22),
                    new selection_1.$ms(1, 32, 1, 33)
                ]);
            });
        });
        test('issue #105730: move right should always skip wrap point', () => {
            ...
            withTestCodeEditor(model, {
                ...
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 22, 1, 22)
                ]);
                moveRight(editor, viewModel, false);
                moveRight(editor, viewModel, false);
                assertCursor(viewModel, [
                    new selection_1.$ms(1, 24, 1, 24),
                ]);
                viewModel.setSelections('test', [
                    new selection_1.$ms(1, 22, 1, 22)
                ]);
        ...
        test('Cursor honors insertSpaces configuration on new line', () => {
            usingCursor({
                ...
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(1, 21), source: 'keyboard' });
                viewModel.type('\n', 'keyboard');
        ...
        test('Cursor honors insertSpaces configuration on tab', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                // Tab on column 1
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 1) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), '             My Second Line123');
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                // Tab on column 2
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 2) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'M            y Second Line123');
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                // Tab on column 3
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 3) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'My            Second Line123');
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                // Tab on column 4
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 4) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'My           Second Line123');
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                // Tab on column 5
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 5) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                ...
                // Tab on column 13
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 13) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'My Second Li ne123');
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                // Tab on column 14
                assert.strictEqual(model.getLineContent(2), 'My Second Line123');
                coreCommands_1.CoreNavigationCommands.MoveTo.runCoreEditorCommand(viewModel, { position: new position_1.$js(2, 14) });
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
        ...
        test('issue #115033: indent and appendText', () => {
            ...
            usingCursor({
                ...
                assertCursor(viewModel, new position_1.$js(2, 6));
            });
        });
            ...
            usingCursor({
                ...
                class TestCommand {
                    ...
                    getEditOperations(model, builder) {
                        builder.addEditOperation(new range_1.$ks(1, 13, 1, 14), '');
                        this.a = builder.trackSelection(viewModel.getSelection());
                    }
        ...
        test('issue #15118: remove auto whitespace when pasting entire line', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new position_1.$js(4, model.getLineMaxColumn(4)));
        ...
        test('issue #40695: maintain cursor position when copying lines using ctrl+c, ctrl+v', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                editor.setSelections([new selection_1.$ms(4, 10, 4, 10)]);
                viewModel.paste('        // I\'m gonna copy this line\n', true);
                assert.strictEqual(model.getValue(), [
                    '    function f() {',
                    '        // I\'m gonna copy this line',
                ...
                assertCursor(viewModel, new position_1.$js(5, 10));
            });
        });
        ...
        test('Enter honors increaseIndentPattern', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 13, 3, 13));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 3));
            });
        });
        ...
        test('Enter honors unIndentedLinePattern', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 15, 2, 15));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(3, 2, 3, 2));
            });
        });
        test('Enter honors indentNextLinePattern', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 14, 2, 14));
                viewModel.type('\n', 'keyboard');
                model.tokenization.forceTokenization(model.getLineCount());
                assertCursor(viewModel, new selection_1.$ms(3, 1, 3, 1));
                moveTo(editor, viewModel, 5, 16, false);
                assertCursor(viewModel, new selection_1.$ms(5, 16, 5, 16));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(6, 2, 6, 2));
            });
        });
        test('Enter honors indentNextLinePattern 2', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'full' }, (editor, viewModel) => {
                ...
                viewModel.type('\n', 'keyboard');
                model.tokenization.forceTokenization(model.getLineCount());
                assertCursor(viewModel, new selection_1.$ms(3, 3, 3, 3));
                viewModel.type('console.log();', 'keyboard');
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 1, 4, 1));
            });
        });
        ...
        test('Enter supports selection 1', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 4));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(5, 1, 5, 1));
        ...
        test('Enter supports selection 2', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 12, 2, 13));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(3, 3, 3, 3));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 3));
        ...
        test('Enter honors tabSize and insertSpaces 1', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 12, 1, 12));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(2, 5, 2, 5));
                model.tokenization.forceTokenization(model.getLineCount());
                moveTo(editor, viewModel, 3, 13, false);
                assertCursor(viewModel, new selection_1.$ms(3, 13, 3, 13));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 9, 4, 9));
            });
        });
        test('Enter honors tabSize and insertSpaces 2', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 16, 3, 16));
                viewModel.type('\n', 'keyboard');
        ...
        test('Enter supports intentional indentation', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(5, 4, 5, 4));
                viewModel.type('\n', 'keyboard');
                assert.strictEqual(model.getLineContent(5), '\t\t}');
                assertCursor(viewModel, new selection_1.$ms(6, 3, 6, 3));
            });
        });
        test('Enter should not adjust cursor position when press enter in the middle of a line 1', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 9, 3, 9));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 3));
        ...
        test('Enter should not adjust cursor position when press enter in the middle of a line 3', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 11, 3, 11));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 5, 4, 5));
                assert.strictEqual(model.getLineContent(4), '     true;', '001');
            });
        });
        test('Enter should adjust cursor position when press enter in the middle of leading whitespaces 1', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 2, 3, 2));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 2, 4, 2));
                assert.strictEqual(model.getLineContent(4), '\t\treturn true;', '001');
        ...
        test('Enter should adjust cursor position when press enter in the middle of leading whitespaces 2', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 4, 3, 4));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 3));
                assert.strictEqual(model.getLineContent(4), '\t\t\treturn true;', '001');
                moveTo(editor, viewModel, 4, 1, false);
        ...
        test('Enter should adjust cursor position when press enter in the middle of leading whitespaces 3', () => {
            usingCursor({
                ...
                moveTo(editor, viewModel, 4, 3, false);
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(5, 3, 5, 3));
                assert.strictEqual(model.getLineContent(5), '    return true;', '002');
            });
        });
        test('Enter should adjust cursor position when press enter in the middle of leading whitespaces 4', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 3, 3, 3));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 4, 4, 4));
                assert.strictEqual(model.getLineContent(4), '    return true;', '001');
                moveTo(editor, viewModel, 9, 4, false);
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(10, 5, 10, 5));
        ...
        test('Enter should adjust cursor position when press enter in the middle of leading whitespaces 5', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 5, 4, 3));
                viewModel.type('\n', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(4, 3, 4, 3));
                assert.strictEqual(model.getLineContent(4), '    return true;', '001');
            });
        ...
        test('issue microsoft/monaco-editor#108 part 1/2: Auto indentation on Enter with selection is half broken', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(3, 8, 2, 12));
                viewModel.type('\n', 'keyboard');
                assert.strictEqual(model.getLineContent(3), '\treturn x;');
                assertCursor(viewModel, new position_1.$js(3, 2));
            });
        });
        test('issue microsoft/monaco-editor#108 part 2/2: Auto indentation on Enter with selection is half broken', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 12, 3, 8));
                viewModel.type('\n', 'keyboard');
                assert.strictEqual(model.getLineContent(3), '\treturn x;');
                assertCursor(viewModel, new position_1.$js(3, 2));
            });
        ...
        test('type honors indentation rules: ruby keywords', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'full' }, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(4, 7, 4, 7));
        ...
        test('type honors users indentation adjustment', () => {
            usingCursor({
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 3, 2, 3));
                viewModel.type(' ', 'keyboard');
                assertCursor(viewModel, new selection_1.$ms(2, 4, 2, 4));
        ...
        test('issue #36090: JS: editor.autoIndent seems to be broken', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'advanced' }, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(7, 6, 7, 6));
                viewModel.type('\n', 'keyboard');
                assert.strictEqual(model.getValue(), [
                    'class ItemCtrl {',
                    '    getPropertiesByItemId(id) {',
                ...
                assertCursor(viewModel, new selection_1.$ms(8, 5, 8, 5));
            });
        });
        test('issue #115304: OnEnter broken for TS', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'advanced' }, (editor, viewModel) => {
                moveTo(editor, viewModel, 1, 4, false);
                assertCursor(viewModel, new selection_1.$ms(1, 4, 1, 4));
                viewModel.type('\n', 'keyboard');
                assert.strictEqual(model.getValue(), [
                    '/**',
                    ' * ',
        ...
        test('issue #38261: TAB key results in bizarre indentation in C++ mode ', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'advanced' }, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(8, 1, 8, 1));
                coreCommands_1.CoreEditingCommands.Tab.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getValue(), [
                    'int main() {',
                    '  return 0;',
                ...
                assert.deepStrictEqual(viewModel.getSelection(), new selection_1.$ms(8, 3, 8, 3));
            });
        });
        ...
        test('typing in json', () => {
            ...
            withTestCodeEditor(model, { autoIndent: 'full' }, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(10, 18, 10, 18));
                viewModel.type('\n', 'keyboard');
        ...
        test('issue #72177: multi-character autoclose with conflicting patterns', () => {
            ...
            usingCursor({
                ...
                model.setValue('(');
                viewModel.setSelections('test', [new selection_1.$ms(1, 2, 1, 2)]);
                viewModel.type('*', 'keyboard');
        ...
        test('issue #25658 - Do not auto-close single/double quotes after word characters', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 1000, 1, 1000)]);
                ...
                viewModel.setSelections('test', [new selection_1.$ms(2, 1000, 2, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste3 = teste" ok');
                assert.strictEqual(model.getLineContent(3), 'teste3 = teste" ok');
                viewModel.setSelections('test', [new selection_1.$ms(3, 1000, 3, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste4 = teste "ok');
                assert.strictEqual(model.getLineContent(4), 'teste4 = teste "ok"');
                // Second gif
                viewModel.setSelections('test', [new selection_1.$ms(4, 1000, 4, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste \'');
                assert.strictEqual(model.getLineContent(5), 'teste \'\'');
                viewModel.setSelections('test', [new selection_1.$ms(5, 1000, 5, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste "');
                assert.strictEqual(model.getLineContent(6), 'teste ""');
                viewModel.setSelections('test', [new selection_1.$ms(6, 1000, 6, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste\'');
                assert.strictEqual(model.getLineContent(7), 'teste\'');
                viewModel.setSelections('test', [new selection_1.$ms(7, 1000, 7, 1000)]);
                typeCharacters(viewModel, '\n');
                model.tokenization.forceTokenization(model.getLineCount());
                typeCharacters(viewModel, 'teste"');
        ...
        test('issue #37315 - overtypes only those characters that it inserted', () => {
            usingCursor({
                ...
                assert.strictEqual(model.getLineContent(1), 'x=(asd)');
                // do not overtype!
                viewModel.setSelections('test', [new selection_1.$ms(2, 4, 2, 4)]);
                viewModel.type(')', 'keyboard');
        ...
        test('issue #37315 - it overtypes only once', () => {
            usingCursor({
                ...
                viewModel.type(')', 'keyboard');
                assert.strictEqual(model.getLineContent(1), 'x=()');
                viewModel.setSelections('test', [new selection_1.$ms(1, 4, 1, 4)]);
                viewModel.type(')', 'keyboard');
                assert.strictEqual(model.getLineContent(1), 'x=())');
            });
        });
        ...
        test('issue #78527 - does not close quote on odd count', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 29, 1, 29)]);
                viewModel.type('[', 'keyboard');
        ...
        test('issue #78975 - Parentheses swallowing does not work when parentheses are inserted by autocomplete', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 8, 1, 8)]);
                viewModel.executeEdits('snippet', [{ range: new range_1.$ks(1, 6, 1, 8), text: 'id=""' }], () => [new selection_1.$ms(1, 10, 1, 10)]);
        ...
        test('issue #90016: allow accents on mac US intl keyboard to surround selection', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 1, 1, 5)]);
                // Typing ` + e on the mac US intl kb layout
                viewModel.startComposition();
                viewModel.type('\'', 'keyboard');
        ...
        test('issue #53357: Over typing ignores characters after backslash', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 13, 1, 13)]);
                viewModel.type('\'', 'keyboard');
        ...
        test('issue #2773: Accents (´`¨^, others?) are inserted in the wrong position (Mac)', () => {
            usingCursor({
                ...
                viewModel.endComposition('keyboard');
                assert.strictEqual(model.getValue(), '`hello\nworld');
                assertCursor(viewModel, new selection_1.$ms(1, 2, 2, 2));
            });
        });
        test('issue #26820: auto close quotes when not used as accents', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 10, 1, 10)]);
                viewModel.startComposition();
                viewModel.type('\'', 'keyboard');
                viewModel.compositionType('\'', 1, 0, 0, 'keyboard');
                viewModel.endComposition('keyboard');
        ...
        test('issue #144693: Typing a quote using US Intl PC keyboard layout always surrounds words', () => {
            usingCursor({
                ...
                viewModel.setSelections('test', [new selection_1.$ms(1, 7, 1, 12)]);
                // Pressing ' + e
                viewModel.startComposition();
                viewModel.type(`'`, 'keyboard');
        ...
        test('issue #41825: Special handling of quotes in surrounding pairs', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                editor.setSelections([
                    new selection_1.$ms(1, 9, 1, 10),
                    new selection_1.$ms(1, 12, 1, 13)
                ]);
                viewModel.type('"', 'keyboard');
        ...
        test('issue #7100: Mouse word selection is strange when non-word character is at the end of line', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                coreCommands_1.CoreNavigationCommands.WordSelect.runEditorCommand(null, editor, {
                    position: new position_1.$js(3, 7)
                });
                assertCursor(viewModel, new selection_1.$ms(3, 7, 3, 7));
                coreCommands_1.CoreNavigationCommands.WordSelectDrag.runEditorCommand(null, editor, {
                    position: new position_1.$js(4, 7)
                });
                assertCursor(viewModel, new selection_1.$ms(3, 7, 4, 7));
            });
        });
        test('issue #112039: shift-continuing a double/triple-click and drag selection does not remember its starting mode', () => {
            ...
            withTestCodeEditor(model, {}, (editor, viewModel) => {
                coreCommands_1.CoreNavigationCommands.WordSelect.runEditorCommand(null, editor, {
                    position: new position_1.$js(2, 6)
                });
                coreCommands_1.CoreNavigationCommands.MoveToSelect.runEditorCommand(null, editor, {
                    position: new position_1.$js(1, 8),
                });
                assertCursor(viewModel, new selection_1.$ms(2, 12, 1, 6));
            });
        });
        ...
        test('issue #111513: Text gets automatically selected when typing at the same location in another editor', () => {
            ...
            withTestCodeEditor(model, {}, (editor1, viewModel1) => {
                ...
                withTestCodeEditor(model, {}, (editor2, viewModel2) => {
                    ...
                    assertCursor(viewModel2, new position_1.$js(2, 2));
                    assertCursor(viewModel1, new position_1.$js(2, 2));
                });
            });
        });
    });
    suite('Undo stops', () => {
        ...
        test('there is an undo stop between typing and deleting left', () => {
            ...
            (0, testCodeEditor_1.$X0b)(model, {}, (editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(1, 3, 1, 3)]);
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 3, 1, 3));
            });
            model.dispose();
        });
        ...
        test('there is an undo stop between deleting left and typing', () => {
            ...
            (0, testCodeEditor_1.$X0b)(model, {}, (editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(2, 8, 2, 8)]);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteLeft.runEditorCommand(null, editor, null);
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 7, 2, 7));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), ' line');
                assertCursor(viewModel, new selection_1.$ms(2, 1, 2, 1));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'Another line');
                assertCursor(viewModel, new selection_1.$ms(2, 8, 2, 8));
            });
            model.dispose();
        });
        ...
        test('there is an undo stop between deleting right and typing', () => {
            ...
            (0, testCodeEditor_1.$X0b)(model, {}, (editor, viewModel) => {
                viewModel.setSelections('test', [new selection_1.$ms(2, 9, 2, 9)]);
                coreCommands_1.CoreEditingCommands.DeleteRight.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteRight.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteRight.runEditorCommand(null, editor, null);
                coreCommands_1.CoreEditingCommands.DeleteRight.runEditorCommand(null, editor, null);
                ...
                assertCursor(viewModel, new selection_1.$ms(2, 13, 2, 13));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
                assert.strictEqual(model.getLineContent(2), 'Another ');
                assertCursor(viewModel, new selection_1.$ms(2, 9, 2, 9));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
        ...
        test('inserts undo stop when typing space', () => {
            ...
            (0, testCodeEditor_1.$X0b)(model, {}, (editor, viewModel) => {
                ...
                assertCursor(viewModel, new selection_1.$ms(1, 24, 1, 24));
                coreCommands_1.CoreEditingCommands.Undo.runEditorCommand(null, editor, null);
