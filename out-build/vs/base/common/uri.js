...
define(["require", "exports", "vs/base/common/path", "vs/base/common/platform"], function (require, exports, paths, platform_1) {
    ...
    exports.$Tf = exports.$Sf = exports.URI = void 0;
    ...
    class URI {
        ...
        static joinPath(uri, ...pathFragment) {
            ...
            let newPath;
            if (platform_1.$i && uri.scheme === 'file') {
                newPath = URI.file(paths.$5d.join($Tf(uri, true), ...pathFragment)).path;
            }
            else {
                newPath = paths.$6d.join(uri.path, ...pathFragment);
            }
    ...
    exports.$Sf = $Sf;
    const _pathSepMarker = platform_1.$i ? 1 : undefined;
     ...
     */
    function $Tf(uri, keepDriveLetterCasing) {
        let value;
