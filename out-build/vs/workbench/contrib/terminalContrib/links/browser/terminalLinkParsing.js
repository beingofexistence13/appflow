...
define(["require", "exports", "vs/base/common/lazy"], function (require, exports, lazy_1) {
    ...
    exports.$1kb = exports.$Zkb = exports.$Ykb = exports.$Xkb = exports.$Wkb = exports.$Vkb = exports.$Ukb = void 0;
    /**
     ...
     */
    const linkSuffixRegexEol = new lazy_1.$T(() => generateLinkSuffixRegex(true));
    /**
     * A regex that extracts the link suffix which contains line and column information.
     */
    const linkSuffixRegex = new lazy_1.$T(() => generateLinkSuffixRegex(false));
     ...
     */
    function $Xkb(link) {
        return $Ykb(linkSuffixRegexEol.value.exec(link));
    }
    exports.$Xkb = $Xkb;
    function $Ykb(match) {
     ...
     * and `foo\bar`.
     */
    const winLocalLinkClause = '(?:(?:' + `(?:${exports.$1kb}|${RegexPathConstants.WinOtherPathPrefix})` + '|(?:' + RegexPathConstants.WinExcludedStartPathCharactersClause + RegexPathConstants.WinExcludedPathCharactersClause + '*))?(?:' + RegexPathConstants.WinPathSeparatorClause + '(?:' + RegexPathConstants.WinExcludedPathCharactersClause + ')+)+)';
