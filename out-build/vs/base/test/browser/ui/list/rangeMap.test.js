...
define(["require", "exports", "assert", "vs/base/browser/ui/list/rangeMap", "vs/base/common/range", "vs/base/test/common/utils"], function (require, exports, assert, rangeMap_1, range_1, utils_1) {
    ...
    suite('RangeMap', () => {
        ...
        test('multiIntersect', () => {
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 0, end: 0 }, [{ range: { start: 0, end: 10 }, size: 1 }]), []);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 10, end: 20 }, [{ range: { start: 0, end: 10 }, size: 1 }]), []);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 2, end: 8 }, [{ range: { start: 0, end: 10 }, size: 1 }]), [{ range: { start: 2, end: 8 }, size: 1 }]);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 2, end: 8 }, [{ range: { start: 0, end: 10 }, size: 1 }, { range: { start: 10, end: 20 }, size: 5 }]), [{ range: { start: 2, end: 8 }, size: 1 }]);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 12, end: 18 }, [{ range: { start: 0, end: 10 }, size: 1 }, { range: { start: 10, end: 20 }, size: 5 }]), [{ range: { start: 12, end: 18 }, size: 5 }]);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 2, end: 18 }, [{ range: { start: 0, end: 10 }, size: 1 }, { range: { start: 10, end: 20 }, size: 5 }]), [{ range: { start: 2, end: 10 }, size: 1 }, { range: { start: 10, end: 18 }, size: 5 }]);
            assert.deepStrictEqual((0, rangeMap_1.$eQ)({ start: 2, end: 28 }, [{ range: { start: 0, end: 10 }, size: 1 }, { range: { start: 10, end: 20 }, size: 5 }, { range: { start: 20, end: 30 }, size: 10 }]), [{ range: { start: 2, end: 10 }, size: 1 }, { range: { start: 10, end: 20 }, size: 5 }, { range: { start: 20, end: 28 }, size: 10 }]);
        });
        test('consolidate', () => {
            assert.deepStrictEqual((0, rangeMap_1.$gQ)([]), []);
            assert.deepStrictEqual((0, rangeMap_1.$gQ)([{ range: { start: 0, end: 10 }, size: 1 }]), [{ range: { start: 0, end: 10 }, size: 1 }]);
            assert.deepStrictEqual((0, rangeMap_1.$gQ)([
        ...
        test('empty', () => {
            const rangeMap = new rangeMap_1.$hQ();
    ...
    suite('RangeMap with top padding', () => {
        test('empty', () => {
            const rangeMap = new rangeMap_1.$hQ(10);
