...
define(["require", "exports", "vs/base/common/path"], function (require, exports, path_1) {
    ...
    exports.$HWb = exports.$GWb = exports.$FWb = exports.$EWb = exports.$DWb = exports.$CWb = void 0;
    /**
     ...
     */
    function $CWb(lines, bufferWidth, range, startLine) {
        const bufferRange = {
            start: {
                x: range.startColumn,
    ...
    exports.$CWb = $CWb;
    function $DWb(bufferRange, viewportY) {
        return {
            start: {
    ...
    exports.$DWb = $DWb;
    function $EWb(buffer, lineStart, lineEnd, cols) {
    ...
    exports.$EWb = $EWb;
    function $FWb(buffer, lineStart, lineEnd, cols) {
     ...
     */
    function $GWb(capabilities, y, text, osPath, logService) {
    ...
    exports.$GWb = $GWb;
    function $HWb(os) {
        return os === 1 /* OperatingSystem.Windows */ ? path_1.$5d : path_1.$6d;
    }
    exports.$HWb = $HWb;
});
