    ...
    suite('FindModel', () => {
        ...
        function findTest(testName, callback) {
            test(testName, () => {
                ...
                (0, testCodeEditor_1.$X0b)(textArr, {}, (editor) => callback(editor));
                const text = textArr.join('\n');
                const ptBuilder = new pieceTreeTextBufferBuilder_1.$tC();
                ...
                (0, testCodeEditor_1.$X0b)(factory, {}, (editor) => callback(editor));
            });
        }
        ...
        function _getFindState(editor) {
            ...
            currentFindMatches.sort(range_1.$ks.compareRangesUsingStarts);
            allFindMatches.sort(range_1.$ks.compareRangesUsingStarts);
            return {
        ...
        findTest('incremental find from beginning of file', (editor) => {
            ...
            const findState = disposables.add(new findState_1.$t7());
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            ...
            findState.change({ searchScope: [new range_1.$ks(8, 1, 10, 1)] }, true);
        ...
        findTest('find model reacts to position change', (editor) => {
            ...
            editor.trigger('mouse', coreCommands_1.CoreNavigationCommands.MoveTo.id, {
                position: new position_1.$js(6, 20)
            });
        ...
        findTest('find model next stays in scope', (editor) => {
            const findState = disposables.add(new findState_1.$t7());
            findState.change({ searchString: 'hello', wholeWord: true, searchScope: [new range_1.$ks(7, 1, 9, 1)] }, false);
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            assertFindState(editor, [1, 1, 1, 1], null, [
                [7, 14, 7, 19],
                [8, 14, 8, 19]
        ...
        findTest('multi-selection find model next stays in scope (overlap)', (editor) => {
            const findState = disposables.add(new findState_1.$t7());
            findState.change({ searchString: 'hello', wholeWord: true, searchScope: [new range_1.$ks(7, 1, 8, 2), new range_1.$ks(8, 1, 9, 1)] }, false);
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            assertFindState(editor, [1, 1, 1, 1], null, [
                [7, 14, 7, 19],
                [8, 14, 8, 19]
        ...
        findTest('multi-selection find model next stays in scope', (editor) => {
            const findState = disposables.add(new findState_1.$t7());
            findState.change({ searchString: 'hello', matchCase: true, wholeWord: false, searchScope: [new range_1.$ks(6, 1, 7, 38), new range_1.$ks(9, 3, 9, 38)] }, false);
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            assertFindState(editor, [1, 1, 1, 1], null, [
                [6, 14, 6, 19],
        ...
        findTest('selectAllMatches', (editor) => {
            ...
            assert.deepStrictEqual(editor.getSelections().map(s => s.toString()), [
                new selection_1.$ms(6, 14, 6, 19),
                new selection_1.$ms(6, 27, 6, 32),
                new selection_1.$ms(7, 14, 7, 19),
                new selection_1.$ms(8, 14, 8, 19)
            ].map(s => s.toString()));
        ...
        findTest('issue #14143 selectAllMatches should maintain primary cursor if feasible', (editor) => {
            ...
            editor.setSelection(new range_1.$ks(7, 14, 7, 19));
            findModel.selectAllMatches();
            assert.deepStrictEqual(editor.getSelections().map(s => s.toString()), [
                new selection_1.$ms(7, 14, 7, 19),
                new selection_1.$ms(6, 14, 6, 19),
            ...
            assert.deepStrictEqual(editor.getSelection().toString(), new selection_1.$ms(7, 14, 7, 19).toString());
        ...
        findTest('replace when search string has look ahed regex and cursor is at the last find match', (editor) => {
            ...
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            editor.trigger('mouse', coreCommands_1.CoreNavigationCommands.MoveTo.id, {
                position: new position_1.$js(8, 14)
            });
        ...
        findTest('issue #27083. search scope works even if it is a single line', (editor) => {
            const findState = disposables.add(new findState_1.$t7());
            findState.change({ searchString: 'hello', wholeWord: true, searchScope: [new range_1.$ks(7, 1, 8, 1)] }, false);
            const findModel = disposables.add(new findModel_1.$J7(editor, findState));
            assertFindState(editor, [1, 1, 1, 1], null, [
                [7, 14, 7, 19]
            ]);
