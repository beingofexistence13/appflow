...
define(["require", "exports", "assert", "vs/base/browser/dom"], function (require, exports, assert, dom_1) {
    ...
    suite('dom', () => {
        ...
        test('multibyteAwareBtoa', () => {
            assert.ok((0, dom_1.$wP)('hello world').length > 0);
            assert.ok((0, dom_1.$wP)('平仮名').length > 0);
            assert.ok((0, dom_1.$wP)(new Array(100000).fill('vs').join('')).length > 0); // https://github.com/microsoft/vscode/issues/112013
        });
        suite('$', () => {
        ...
        test('cssValueWithDefault', () => {
            assert.strictEqual((0, dom_1.$pP)('red', 'blue'), 'red');
            assert.strictEqual((0, dom_1.$pP)(undefined, 'blue'), 'blue');
            assert.strictEqual((0, dom_1.$pP)('var(--my-var)', 'blue'), 'var(--my-var, blue)');
            assert.strictEqual((0, dom_1.$pP)('var(--my-var, red)', 'blue'), 'var(--my-var, red)');
            assert.strictEqual((0, dom_1.$pP)('var(--my-var, var(--my-var2))', 'blue'), 'var(--my-var, var(--my-var2, blue))');
        });
    });
});
