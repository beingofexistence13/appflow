...
define(["require", "exports", "vs/base/common/lazy", "vs/base/common/path"], function (require, exports, lazy_1, path_1) {
    ...
    exports.$jq = exports.$iq = exports.$hq = exports.$gq = exports.$fq = exports.$eq = exports.$dq = exports.$cq = exports.$bq = exports.$aq = exports.$_p = exports.$$p = exports.$0p = void 0;
    ...
    function $0p(one, other, caseSensitive = false) {
        const a = one || '';
        const b = other || '';
    ...
    function $hq(one, other, caseSensitive = false) {
        ...
        for (let i = 0;; i++) {
            ...
            if (endOne && endOther) {
                return $0p(oneParts[i], otherParts[i], caseSensitive);
            }
            else if (endOne) {
                return -1;
            }
    ...
    exports.$hq = $hq;
    function $iq(one, other, lookFor) {
        const elementAName = one.toLowerCase();
        const elementBName = other.toLowerCase();
        // Sort prefix matches over non prefix matches
        const prefixCompare = $jq(one, other, lookFor);
        if (prefixCompare) {
        ...
        const r = $0p(elementAName, elementBName);
        if (r !== 0) {
            return r;
        }
        // Compare by name
