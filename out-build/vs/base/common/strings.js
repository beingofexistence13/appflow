...
define(["require", "exports", "vs/base/common/cache", "vs/base/common/lazy"], function (require, exports, cache_1, lazy_1) {
    ...
    exports.$if = exports.$hf = exports.$gf = exports.$ff = exports.GraphemeBreakType = exports.$ef = exports.$df = exports.$cf = exports.$bf = exports.$af = exports.$_e = exports.$$e = exports.$0e = exports.$9e = exports.$8e = exports.$7e = exports.$6e = exports.$5e = exports.$4e = exports.$3e = exports.$2e = exports.$1e = exports.$Ze = exports.$Ye = exports.$Xe = exports.$We = exports.$Ve = exports.$Ue = exports.$Te = exports.$Se = exports.$Re = exports.$Qe = exports.$Pe = exports.$Oe = exports.$Ne = exports.$Me = exports.$Le = exports.$Ke = exports.$Je = exports.$Ie = exports.$He = exports.$Ge = exports.$Fe = exports.$Ee = exports.$De = exports.$Ce = exports.$Be = exports.$Ae = exports.$ze = exports.$ye = exports.$xe = exports.$we = exports.$ve = exports.$ue = exports.$te = exports.$se = exports.$re = exports.$qe = exports.$pe = exports.$oe = exports.$ne = exports.$me = void 0;
    function $me(str) {
    ...
    exports.$re = $re;
    function $se(value, maxLength, suffix = '…') {
     ...
     */
    function $te(haystack, needle = ' ') {
        const trimmed = $ue(haystack, needle);
        return $ve(trimmed, needle);
    }
    exports.$te = $te;
    /**
    ...
    exports.$xe = $xe;
    function $ye(searchString, isRegex, options = {}) {
        if (!searchString) {
            throw new Error('Cannot create regex from empty string');
        }
        if (!isRegex) {
            searchString = $qe(searchString);
        }
     ...
     */
    function $Ce(str, start = 0, end = str.length) {
     ...
     * If string is empty or contains only whitespaces, returns -1
     */
    function $De(str, startIndex = str.length - 1) {
     ...
     */
    function $Ee(str, search, replacer) {
        const parts = [];
        let last = 0;
    ...
    exports.$Fe = $Fe;
    function $Ge(a, b, aStart = 0, aEnd = a.length, bStart = 0, bEnd = b.length) {
    ...
    exports.$Ge = $Ge;
    function $He(a, b) {
        return $Ie(a, b, 0, a.length, 0, b.length);
    }
    exports.$He = $He;
    function $Ie(a, b, aStart = 0, aEnd = a.length, bStart = 0, bEnd = b.length) {
        for (; aStart < aEnd && bStart < bEnd; aStart++, bStart++) {
            ...
            if (codeA >= 128 || codeB >= 128) {
                ...
                return $Ge(a.toLowerCase(), b.toLowerCase(), aStart, aEnd, bStart, bEnd);
            }
    ...
    exports.$Le = $Le;
    function $Me(a, b) {
        return a.length === b.length && $Ie(a, b) === 0;
    }
    exports.$Me = $Me;
    function $Ne(str, candidate) {
        const candidateLength = candidate.length;
        if (candidate.length > str.length) {
            return false;
        }
        return $Ie(str, candidate, 0, candidateLength) === 0;
    }
    exports.$Ne = $Ne;
    /**
     ...
     * See http://en.wikipedia.org/wiki/Surrogate_pair
     */
    function $Se(highSurrogate, lowSurrogate) {
     ...
     */
    function $Te(str, len, offset) {
        const charCode = str.charCodeAt(offset);
        if ($Qe(charCode) && offset + 1 < len) {
            const nextCharCode = str.charCodeAt(offset + 1);
            if ($Re(nextCharCode)) {
                return $Se(charCode, nextCharCode);
            }
        }
        return charCode;
    }
    ...
    function getPrevCodePoint(str, offset) {
        ...
        if ($Re(charCode) && offset > 1) {
            const prevCharCode = str.charCodeAt(offset - 2);
            if ($Qe(prevCharCode)) {
                return $Se(prevCharCode, charCode);
            }
        }
        return charCode;
    }
    class $Ue {
        ...
        nextCodePoint() {
            const codePoint = $Te(this.c, this.d, this.e);
            this.e += (codePoint >= 65536 /* Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN */ ? 2 : 1);
            return codePoint;
        }
        eol() {
    ...
    exports.$Ve = $Ve;
    function $We(str, initialOffset) {
        const iterator = new $Ve(str, initialOffset);
        return iterator.nextGraphemeLength();
    }
    exports.$We = $We;
    function $Xe(str, initialOffset) {
        const iterator = new $Ve(str, initialOffset);
        return iterator.prevGraphemeLength();
    }
    exports.$Xe = $Xe;
    function $Ye(str, offset) {
        if (offset > 0 && $Re(str.charCodeAt(offset))) {
            offset--;
        }
        const endOffset = offset + $We(str, offset);
        const startOffset = endOffset - $Xe(str, endOffset);
        return [startOffset, endOffset];
    }
    exports.$Ye = $Ye;
    function $Ze(str) {
        const iterator = new $Ve(str);
        let length = 0;
        while (!iterator.eol()) {
            length++;
    ...
    exports.$2e = $2e;
    exports.$3e = /[\u2028\u2029]/; // LINE SEPARATOR (LS) or PARAGRAPH SEPARATOR (PS)
    /**
     * Returns true if `str` contains unusual line terminators, like LS or PS
     */
    function $4e(str) {
        return exports.$3e.test(str);
    }
    exports.$4e = $4e;
    function $5e(charCode) {
    ...
    exports.$8e = $8e;
    // -- UTF-8 BOM
    exports.$9e = String.fromCharCode(65279 /* CharCode.UTF8_BOM */);
    function $0e(str) {
        return !!(str && str.length > 0 && str.charCodeAt(0) === 65279 /* CharCode.UTF8_BOM */);
    }
    exports.$0e = $0e;
    function $$e(str) {
        return $0e(str) ? str.substr(1) : str;
    }
    exports.$$e = $$e;
    /**
    ...
    exports.$_e = $_e;
    function $af(target, ignoreEscapedChars = false) {
        if (!target) {
            return false;
        }
    ...
    */
    function $ff(offset, str) {
        ...
        const iterator = new $Ue(str, offset);
    ...
    function getOffsetBeforeLastEmojiComponent(initialOffset, str) {
        ...
        // structure of emojis.
        const iterator = new $Ue(str, initialOffset);
    ...
    class $hf {
        ...
        static { this.d = new cache_1.$ie((locales) => {
        ...
        static getInstance(locales) {
            return $hf.d.get(Array.from(locales));
        }
        static { this.e = new lazy_1.$T(() => Object.keys($hf.c.value).filter((k) => !k.startsWith('_'))); }
        static getLocales() {
            return $hf.e.value;
        }
        constructor(f) {
