...
0 S node      1058  1056  0  80   0 -   770 pipe_w   888   9 14:43 ?        00:00:00 grep root`;
    suite('ExtHostTunnelService', () => {
        test('getSockets', function () {
            const result = (0, extHostTunnelService_1.$Qdc)(procSockets);
        ...
        test('loadConnectionTable', function () {
            const result = (0, extHostTunnelService_1.$Tdc)(tcp);
        ...
        test('loadListeningPorts', function () {
            const result = (0, extHostTunnelService_1.$Rdc)(tcp, tcp6);
        ...
        test('tryFindRootPorts', function () {
            const rootProcesses = (0, extHostTunnelService_1.$Udc)(psStdOut);
            assert.strictEqual(rootProcesses.length, 6);
            const result = (0, extHostTunnelService_1.$Wdc)([{ socket: 1000, ip: '127.0.0.1', port: 5000 }], psStdOut, new Map());
            assert.strictEqual(result.size, 1);
            assert.strictEqual(result.get(5000)?.pid, 514);
        });
        test('findPorts', async function () {
            const result = await (0, extHostTunnelService_1.$Vdc)((0, extHostTunnelService_1.$Rdc)(tcp, tcp6), (0, extHostTunnelService_1.$Qdc)(procSockets), processes);
        ...
        test('parseIpAddress', function () {
            assert.strictEqual((0, extHostTunnelService_1.$Sdc)('00000000000000000000000001000000'), '0:0:0:0:0:0:0:1');
            assert.strictEqual((0, extHostTunnelService_1.$Sdc)('0000000000000000FFFF0000040510AC'), '0:0:0:0:0:ffff:ac10:504');
        });
    });
});
