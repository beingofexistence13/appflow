...
define(["require", "exports", "assert", "sinon", "vs/base/common/event", "vs/workbench/api/common/extHostTreeViews", "vs/workbench/api/common/extHostCommands", "vs/workbench/api/common/extHost.protocol", "vs/workbench/api/test/common/testRPCProtocol", "vs/base/test/common/mock", "vs/workbench/common/views", "vs/platform/log/common/log", "vs/workbench/services/extensions/common/extensions", "vs/base/test/common/timeTravelScheduler", "vs/base/test/common/utils"], function (require, exports, assert, sinon, event_1, extHostTreeViews_1, extHostCommands_1, extHost_protocol_1, testRPCProtocol_1, mock_1, views_1, log_1, extensions_1, timeTravelScheduler_1, utils_1) {
    ...
    suite('ExtHostTreeView', function () {
        ...
        setup(() => {
            ...
            testObject = store.add(new extHostTreeViews_1.$8bc(target, new extHostCommands_1.$kM(rpcProtocol, new log_1.$fj(), new class extends (0, mock_1.$rT)() {
                onExtensionError() {
                    return true;
                }
            }), new log_1.$fj()));
            onDidChangeTreeNode = new event_1.$fd();
            onDidChangeTreeNodeWithId = new event_1.$fd();
            testObject.createTreeView('testNodeTreeProvider', { treeDataProvider: aNodeTreeDataProvider() }, extensions_1.$KF);
            testObject.createTreeView('testNodeWithIdTreeProvider', { treeDataProvider: aNodeWithIdTreeDataProvider() }, extensions_1.$KF);
            testObject.createTreeView('testNodeWithHighlightsTreeProvider', { treeDataProvider: aNodeWithHighlightedLabelTreeDataProvider() }, extensions_1.$KF);
        ...
        test('reveal will throw an error if getParent is not implemented', () => {
            const treeView = testObject.createTreeView('treeDataProvider', { treeDataProvider: aNodeTreeDataProvider() }, extensions_1.$KF);
        ...
        test('reveal will return empty array for root element', () => {
            ...
            const treeView = testObject.createTreeView('treeDataProvider', { treeDataProvider: aCompleteNodeTreeDataProvider() }, extensions_1.$KF);
            const expected = {
