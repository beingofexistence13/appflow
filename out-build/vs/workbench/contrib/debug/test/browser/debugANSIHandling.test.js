...
define(["require", "exports", "assert", "vs/base/common/color", "vs/base/common/lifecycle", "vs/base/common/uuid", "vs/base/test/common/utils", "vs/platform/theme/test/common/testThemeService", "vs/workbench/contrib/debug/browser/debugANSIHandling", "vs/workbench/contrib/debug/browser/linkDetector", "vs/workbench/contrib/debug/test/browser/callStack.test", "vs/workbench/contrib/debug/test/browser/mockDebugModel", "vs/workbench/contrib/terminal/common/terminalColorRegistry", "vs/workbench/test/browser/workbenchTestServices"], function (require, exports, assert, color_1, lifecycle_1, uuid_1, utils_1, testThemeService_1, debugANSIHandling_1, linkDetector_1, callStack_test_1, mockDebugModel_1, terminalColorRegistry_1, workbenchTestServices_1) {
    ...
    suite('Debug - ANSI Handling', () => {
        ...
        setup(() => {
            ...
            session = (0, callStack_test_1.$vfc)(model);
            ...
            const colors = {};
            for (const color in terminalColorRegistry_1.$Ifb) {
                colors[color] = terminalColorRegistry_1.$Ifb[color].defaults.dark;
            }
            const testTheme = new testThemeService_1.$J0b(colors);
            themeService = new testThemeService_1.$K0b(testTheme);
        ...
        test('appendStylizedStringToContainer', () => {
            ...
            (0, debugANSIHandling_1.$8Rb)(root, 'content1', ['class1', 'class2'], linkDetector, session.root);
            (0, debugANSIHandling_1.$8Rb)(root, 'content2', ['class2', 'class3'], linkDetector, session.root);
        ...
        function getSequenceOutput(sequence) {
            const root = (0, debugANSIHandling_1.$7Rb)(sequence, linkDetector, themeService, session.root);
        ...
        function assertInlineColor(element, colorType, color, message, colorShouldMatch = true) {
            if (color !== undefined) {
                const cssColor = color_1.$Os.Format.CSS.formatRGB(new color_1.$Os(color));
        ...
        test('Expected single 8-bit color sequence operation', () => {
            ...
            for (let i = 16; i <= 255; i++) {
                ...
                assertSingleSequenceElement('\x1b[38;5;' + i + 'm', (child) => {
                    assert(child.classList.contains('code-foreground-colored'), `Custom color class not found after foreground 8-bit color code 38;5;${i}`);
                    assertInlineColor(child, 'foreground', (0, debugANSIHandling_1.$9Rb)(i), `Incorrect or no color styling found after foreground 8-bit color code 38;5;${i}`);
                });
                // Background codes should add custom class and inline style
                assertSingleSequenceElement('\x1b[48;5;' + i + 'm', (child) => {
                    assert(child.classList.contains('code-background-colored'), `Custom color class not found after background 8-bit color code 48;5;${i}`);
                    assertInlineColor(child, 'background', (0, debugANSIHandling_1.$9Rb)(i), `Incorrect or no color styling found after background 8-bit color code 48;5;${i}`);
                });
                ...
                assertSingleSequenceElement('\x1b[58;5;' + i + 'm', (child) => {
                    ...
                    assertInlineColor(child, 'underline', (0, debugANSIHandling_1.$9Rb)(i), `Incorrect or no color styling found after underline 8-bit color code 58;5;${i}`);
                });
            }
            ...
            assertSingleSequenceElement('\x1b[48;5;100;42;77;99;4;24m', (child) => {
                ...
                assertInlineColor(child, 'background', (0, debugANSIHandling_1.$9Rb)(100));
            });
        });
        test('Expected single 24-bit color sequence operation', () => {
            ...
            for (let r = 0; r <= 255; r += 64) {
                for (let g = 0; g <= 255; g += 64) {
                    for (let b = 0; b <= 255; b += 64) {
                        const color = new color_1.$Ls(r, g, b);
            ...
            assertSingleSequenceElement('\x1b[48;2;100;42;77;99;200;75m', (child) => {
                ...
                assertInlineColor(child, 'background', new color_1.$Ls(100, 42, 77), `Color code "48;2;100;42;77;99;200;75" should  style background-color as rgb(100,42,77).`);
            });
        });
        /**
        ...
        test('Expected multiple sequence operation', () => {
            ...
            assertMultipleSequenceElements('\x1b[38;2;10;20;30mfg10,20,30\x1b[48;2;167;168;169mbg167,168,169\x1b[7m8ReverseVideo\x1b[7mDuplicateReverseVideo\x1b[27mReverseOff\x1b[27mDupReverseOff', [
                (fg10_20_30) => {
                    ...
                    assertInlineColor(fg10_20_30, 'foreground', new color_1.$Ls(10, 20, 30), '24-bit RGBA ANSI color code (10,20,30) should add matching color inline style.');
                },
                (bg167_168_169) => {
                    ...
                    assertInlineColor(bg167_168_169, 'background', new color_1.$Ls(167, 168, 169), '24-bit RGBA ANSI background color code (167,168,169) should add matching color inline style.');
                    ...
                    assertInlineColor(bg167_168_169, 'foreground', new color_1.$Ls(10, 20, 30), 'Still 24-bit RGBA ANSI color code (10,20,30) should add matching color inline style.');
                },
                (reverseVideo) => {
                    ...
                    assertInlineColor(reverseVideo, 'foreground', new color_1.$Ls(167, 168, 169), 'Reversed 24-bit RGBA ANSI foreground color code (167,168,169) should add matching former background color inline style.');
                    ...
                    assertInlineColor(reverseVideo, 'background', new color_1.$Ls(10, 20, 30), 'Reversed 24-bit RGBA ANSI background color code (10,20,30) should add matching former foreground color inline style.');
                },
                (dupReverseVideo) => {
                    ...
                    assertInlineColor(dupReverseVideo, 'foreground', new color_1.$Ls(167, 168, 169), 'After second Reverse Video - Reversed 24-bit RGBA ANSI foreground color code (167,168,169) should add matching former background color inline style.');
                    ...
                    assertInlineColor(dupReverseVideo, 'background', new color_1.$Ls(10, 20, 30), 'After second Reverse Video - Reversed 24-bit RGBA ANSI background color code (10,20,30) should add matching former foreground color inline style.');
                },
                (reversedBack) => {
                    ...
                    assertInlineColor(reversedBack, 'background', new color_1.$Ls(167, 168, 169), 'Reversed Back - 24-bit RGBA ANSI background color code (167,168,169) should add matching color inline style.');
                    ...
                    assertInlineColor(reversedBack, 'foreground', new color_1.$Ls(10, 20, 30), 'Reversed Back -  24-bit RGBA ANSI color code (10,20,30) should add matching color inline style.');
                },
                (dupReversedBack) => {
                    ...
                    assertInlineColor(dupReversedBack, 'background', new color_1.$Ls(167, 168, 169), '2nd Reversed Back - 24-bit RGBA ANSI background color code (167,168,169) should add matching color inline style.');
                    ...
                    assertInlineColor(dupReversedBack, 'foreground', new color_1.$Ls(10, 20, 30), '2nd Reversed Back -  24-bit RGBA ANSI color code (10,20,30) should add matching color inline style.');
                },
            ], 6);
            ...
            assertMultipleSequenceElements('\x1b[48;2;167;168;169mbg167,168,169\x1b[7m8ReverseVideo\x1b[27mReverseOff', [
                (bg167_168_169) => {
                    ...
                    assertInlineColor(bg167_168_169, 'background', new color_1.$Ls(167, 168, 169), '24-bit RGBA ANSI color code (167, 168, 169) should add matching background color inline style.');
                },
                (reverseVideo) => {
                    ...
                    assertInlineColor(reverseVideo, 'foreground', new color_1.$Ls(167, 168, 169), 'Reversed 24-bit RGBA ANSI background color code (10,20,30) should add matching former background color inline style.');
                },
                (reversedBack) => {
                    assert.strictEqual(1, reversedBack.classList.length, 'Reversed Back - background ANSI color codes should only add a single class.');
                    ...
                    assert(reversedBack.classList.contains('code-background-colored'), 'Reversed Back -  Background ANSI color codes should add custom background color class.');
                    assertInlineColor(reversedBack, 'background', new color_1.$Ls(167, 168, 169), 'Reversed Back -  24-bit RGBA ANSI color code (10,20,30) should add matching background color inline style.');
                },
            ], 3);
            ...
            assertMultipleSequenceElements('\x1b[58;2;101;102;103m24bitUnderline101,102,103\x1b[58;5;3m8bitsimpleUnderline\x1b[58;2;104;105;106m24bitUnderline104,105,106\x1b[58;5;101m8bitadvanced\x1b[58;2;200;200;200munderline200,200,200\x1b[59mUnderlineColorResetToDefault', [
                (adv24Bit) => {
                    ...
                    assertInlineColor(adv24Bit, 'underline', new color_1.$Ls(101, 102, 103), '24-bit RGBA ANSI color code (101,102,103) should add matching color inline style.');
                },
                (adv8BitSimple) => {
                    ...
                    assertInlineColor(adv8BitSimple, 'underline', new color_1.$Ls(101, 102, 103), 'Change to theme color SHOULD NOT STILL BE 24-bit RGBA ANSI color code (101,102,103) should add matching color inline style.', false);
                },
                (adv24BitAgain) => {
                    ...
                    assertInlineColor(adv24BitAgain, 'underline', new color_1.$Ls(104, 105, 106), '24-bit RGBA ANSI color code (100,100,100) should add matching color inline style.');
                },
                (adv8BitAdvanced) => {
                    ...
                    assertInlineColor(adv8BitAdvanced, 'underline', new color_1.$Ls(104, 105, 106), 'Change to theme color SHOULD NOT BE 24-bit RGBA ANSI color code (104,105,106) should add matching color inline style.', false);
                },
                (adv24BitUnderlin200) => {
                    ...
                    assertInlineColor(adv24BitUnderlin200, 'underline', new color_1.$Ls(200, 200, 200), 'after change underline color SHOULD BE 24-bit RGBA ANSI color code (200,200,200) should add matching color inline style.');
                },
            ...
            assertMultipleSequenceElements('\x1b[34msimple\x1b[38;2;101;102;103m24bit\x1b[38;5;3m8bitsimple\x1b[38;2;104;105;106m24bitAgain\x1b[38;5;101m8bitadvanced', [
                ...
                (adv24Bit) => {
                    ...
                    assertInlineColor(adv24Bit, 'foreground', new color_1.$Ls(101, 102, 103), '24-bit RGBA ANSI color code (101,102,103) should add matching color inline style.');
                },
                (adv8BitSimple) => {
                    ...
                    assertInlineColor(adv8BitSimple, 'foreground', new color_1.$Ls(101, 102, 103), 'SHOULD NOT LONGER BE 24-bit RGBA ANSI color code (101,102,103) after simple color change.', false);
                },
                (adv24BitAgain) => {
                    ...
                    assertInlineColor(adv24BitAgain, 'foreground', new color_1.$Ls(104, 105, 106), '24-bit RGBA ANSI color code (104,105,106) should add matching color inline style.');
                },
                (adv8BitAdvanced) => {
                    ...
                    assertInlineColor(adv8BitAdvanced, 'foreground', new color_1.$Ls(104, 105, 106), 'SHOULD NOT LONGER BE 24-bit RGBA ANSI color code (104,105,106) after advanced color change.', false);
                }
            ], 5);
        });
        /**
        ...
        test('calcANSI8bitColor', () => {
            ...
            for (let i = -10; i <= 15; i += 0.5) {
                assert((0, debugANSIHandling_1.$9Rb)(i) === undefined, 'Values less than 16 passed to calcANSI8bitColor should return undefined.');
            }
            // In-range range decimals
            for (let i = 16.5; i < 254; i += 1) {
                assert((0, debugANSIHandling_1.$9Rb)(i) === undefined, 'Floats passed to calcANSI8bitColor should return undefined.');
            }
            // Above range
            for (let i = 256; i < 300; i += 0.5) {
                assert((0, debugANSIHandling_1.$9Rb)(i) === undefined, 'Values grather than 255 passed to calcANSI8bitColor should return undefined.');
            }
            // All valid colors
            for (let red = 0; red <= 5; red++) {
                for (let green = 0; green <= 5; green++) {
                    for (let blue = 0; blue <= 5; blue++) {
                        const colorOut = (0, debugANSIHandling_1.$9Rb)(16 + red * 36 + green * 6 + blue);
            ...
            for (let i = 232; i <= 255; i++) {
                const grayOut = (0, debugANSIHandling_1.$9Rb)(i);
