...
exports.linkify = exports.LinkDetector = void 0;
...
class LinkDetector {
     ...
     */
    linkify(text, splitLines, workspaceFolder, trustHtml) {
        if (splitLines) {
    ...
    detectLinks(text) {
        ...
        const regexes = [HTML_LINK_REGEX, WEB_LINK_REGEX, PATH_LINK_REGEX];
        const kinds = ['html', 'web', 'path'];
        const result = [];
...
function linkify(text, splitLines, workspaceFolder, trustHtml = false) {
