...
define(["require", "exports", "assert", "vs/workbench/common/editor/editorGroupModel", "vs/workbench/common/editor", "vs/base/common/uri", "vs/workbench/test/browser/workbenchTestServices", "vs/platform/configuration/test/common/testConfigurationService", "vs/platform/instantiation/test/common/instantiationServiceMock", "vs/platform/configuration/common/configuration", "vs/workbench/services/lifecycle/common/lifecycle", "vs/platform/workspace/common/workspace", "vs/platform/registry/common/platform", "vs/platform/telemetry/common/telemetry", "vs/platform/telemetry/common/telemetryUtils", "vs/workbench/common/editor/diffEditorInput", "vs/platform/storage/common/storage", "vs/base/common/lifecycle", "vs/workbench/test/common/workbenchTestServices", "vs/workbench/common/editor/editorInput", "vs/workbench/common/editor/sideBySideEditorInput", "vs/base/common/resources", "vs/base/test/common/utils"], function (require, exports, assert, editorGroupModel_1, editor_1, uri_1, workbenchTestServices_1, testConfigurationService_1, instantiationServiceMock_1, configuration_1, lifecycle_1, workspace_1, platform_1, telemetry_1, telemetryUtils_1, diffEditorInput_1, storage_1, lifecycle_2, workbenchTestServices_2, editorInput_1, sideBySideEditorInput_1, resources_1, utils_1) {
    ...
    suite('EditorGroupModel', () => {
        ...
        function inst() {
            if (!testInstService) {
                testInstService = new instantiationServiceMock_1.$L0b();
            }
            const inst = testInstService;
            inst.stub(storage_1.$Vo, disposables.add(new workbenchTestServices_2.$7dc()));
            inst.stub(lifecycle_1.$7y, disposables.add(new workbenchTestServices_1.$Kec()));
            inst.stub(workspace_1.$Kh, new workbenchTestServices_2.$6dc());
            inst.stub(telemetry_1.$9k, telemetryUtils_1.$bo);
            ...
            inst.stub(configuration_1.$8h, config);
            return inst;
        }
        function createEditorGroupModel(serialized) {
            const group = disposables.add(inst().createInstance(editorGroupModel_1.$4C, serialized));
            disposables.add((0, lifecycle_2.$ic)(() => {
        ...
        class NonSerializableTestEditorInput extends editorInput_1.$tA {
            constructor(id) {
                super();
                this.id = id;
                this.resource = undefined;
        ...
        class TestFileEditorInput extends editorInput_1.$tA {
            ...
            matches(other) {
                ...
                if (other instanceof TestFileEditorInput) {
                    return (0, resources_1.$bg)(other.resource, this.resource);
                }
                return false;
            }
        }
        ...
        setup(() => {
            ...
            disposables.add(platform_1.$8m.as(editor_1.$GE.EditorFactory).registerEditorSerializer('testEditorInputForGroups', TestEditorInputSerializer));
        });
        teardown(() => {
            disposables.clear();
            index = 1;
        ...
        test('openEditor - prefers existing side by side editor if same', () => {
            ...
            const sideBySideInputSame = instantiationService.createInstance(sideBySideEditorInput_1.$VC, undefined, undefined, input1, input1);
            const sideBySideInputDifferent = instantiationService.createInstance(sideBySideEditorInput_1.$VC, undefined, undefined, input1, input2);
        ...
        test('indexOf() - prefers direct matching editor over side by side matching one', () => {
            ...
            const group = createEditorGroupModel();
            const input1 = disposables.add(new TestFileEditorInput('testInput', uri_1.URI.file('fake1')));
            const sideBySideInput = instantiationService.createInstance(sideBySideEditorInput_1.$VC, undefined, undefined, input1, input1);
        ...
        test('contains() - untyped', function () {
            ...
            const diffInput1 = instantiationService.createInstance(diffEditorInput_1.$3eb, 'name', 'description', input1, input2, undefined);
            const diffInput2 = instantiationService.createInstance(diffEditorInput_1.$3eb, 'name', 'description', input2, input1, undefined);
            ...
            const sideBySideInputSame = instantiationService.createInstance(sideBySideEditorInput_1.$VC, 'name', undefined, input1, input1);
            const sideBySideInputDifferent = instantiationService.createInstance(sideBySideEditorInput_1.$VC, 'name', undefined, input1, input2);
        ...
        test('group serialization', function () {
            inst().invokeFunction(accessor => platform_1.$8m.as(editor_1.$GE.EditorFactory).start(accessor));
            const group = createEditorGroupModel();
            const input1 = input();
            const input2 = input();
            const input3 = input();
        ...
        test('Multiple Editors - Pinned and Active (DEFAULT_OPEN_EDITOR_DIRECTION = Direction.LEFT)', function () {
            const inst = new instantiationServiceMock_1.$L0b();
            inst.stub(storage_1.$Vo, disposables.add(new workbenchTestServices_2.$7dc()));
            inst.stub(lifecycle_1.$7y, disposables.add(new workbenchTestServices_1.$Kec()));
            inst.stub(workspace_1.$Kh, new workbenchTestServices_2.$6dc());
            inst.stub(telemetry_1.$9k, telemetryUtils_1.$bo);
            ...
            const group = disposables.add(inst.createInstance(editorGroupModel_1.$4C, undefined));
            const events = groupListener(group);
            const input1 = input();
            const input2 = input();
            const input3 = input();
        ...
        test('Single Group, Single Editor - persist', function () {
            ...
            inst.stub(storage_1.$Vo, disposables.add(new workbenchTestServices_2.$7dc()));
            inst.stub(workspace_1.$Kh, new workbenchTestServices_2.$6dc());
            const lifecycle = disposables.add(new workbenchTestServices_1.$Kec());
            inst.stub(lifecycle_1.$7y, lifecycle);
            inst.stub(telemetry_1.$9k, telemetryUtils_1.$bo);
            const config = new testConfigurationService_1.$G0b();
            ...
            group = disposables.add(inst.createInstance(editorGroupModel_1.$4C, group.serialize()));
            assert.strictEqual(group.count, 1);
            assert.strictEqual(group.activeEditor.matches(input1), true);
            assert.strictEqual(group.previewEditor.matches(input1), true);
            assert.strictEqual(group.isActive(input1), true);
        ...
        test('Multiple Groups, Multiple editors - persist', function () {
            ...
            // Create model again - should load from storage
            group1 = disposables.add(inst.createInstance(editorGroupModel_1.$4C, group1.serialize()));
            group2 = disposables.add(inst.createInstance(editorGroupModel_1.$4C, group2.serialize()));
            assert.strictEqual(group1.count, 3);
            assert.strictEqual(group2.count, 3);
            assert.strictEqual(group1.activeEditor.matches(g1_input2), true);
            assert.strictEqual(group2.activeEditor.matches(g2_input1), true);
