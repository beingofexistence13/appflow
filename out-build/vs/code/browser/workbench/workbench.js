...
define(["require", "exports", "vs/base/browser/browser", "vs/base/common/buffer", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/marshalling", "vs/base/common/network", "vs/base/common/path", "vs/base/common/resources", "vs/base/common/strings", "vs/base/common/uri", "vs/platform/product/common/product", "vs/platform/window/common/window", "vs/workbench/workbench.web.main"], function (require, exports, browser_1, buffer_1, event_1, lifecycle_1, marshalling_1, network_1, path_1, resources_1, strings_1, uri_1, product_1, window_1, workbench_web_main_1) {
    ...
    class ServerKeyedAESCrypto {
        ...
        async seal(data) {
            ...
            return (0, buffer_1.$Zd)(buffer_1.$Fd.wrap(result));
        }
        async unseal(data) {
            ...
            const dataUint8Array = (0, buffer_1.$Yd)(data);
    ...
    class LocalStorageSecretStorageProvider {
        ...
        async d() {
            ...
            const encrypted = window.localStorage.getItem(this.a);
            if (encrypted) {
                try {
                    ...
                    window.localStorage.removeItem(this.a);
                }
            }
            return record;
        }
        ...
        async g() {
            try {
                ...
                window.localStorage.setItem(this.a, encrypted);
            }
            catch (err) {
                console.error(err);
            }
    ...
    class LocalStorageURLCallbackProvider extends lifecycle_1.$kc {
        static { this.a = 0; }
        static { this.b = [
            'scheme',
            'authority',
        ...
        create(options = {}) {
            ...
            return uri_1.URI.parse(window.location.href).with({ path: this.m, query: queryParams.join('&') });
        }
        n() {
            if (this.j) {
                return;
            ...
            this.j = { dispose: () => window.removeEventListener('storage', fn) };
        }
        r() {
            this.j?.dispose();
            this.j = undefined;
    ...
    class WorkspaceProvider {
            ...
            query.forEach((value, key) => {
                switch (key) {
                    ...
                    case WorkspaceProvider.b:
                        if (config.remoteAuthority && value.startsWith(path_1.$6d.sep)) {
                    ...
                    case WorkspaceProvider.d:
                        try {
                            payload = (0, marshalling_1.$0g)(value); // use marshalling#parse() to revive potential URIs
                        }
                        catch (error) {
        ...
        g(workspace, options) {
            ...
            // Folder
            else if ((0, window_1.$RD)(workspace)) {
            ...
            // Workspace
            else if ((0, window_1.$QD)(workspace)) {
        ...
        h(uri) {
            if (this.f.remoteAuthority && uri.scheme === network_1.Schemas.vscodeRemote) {
                ...
                // as `+` in the path.
                return encodeURIComponent(`${path_1.$6d.sep}${(0, strings_1.$ue)(uri.path, path_1.$6d.sep)}`).replaceAll('%2F', '/');
            }
        ...
        j(workspaceA, workspaceB) {
            ...
            if ((0, window_1.$RD)(workspaceA) && (0, window_1.$RD)(workspaceB)) {
                return (0, resources_1.$bg)(workspaceA.folderUri, workspaceB.folderUri); // same workspace
            }
            if ((0, window_1.$QD)(workspaceA) && (0, window_1.$QD)(workspaceB)) {
                return (0, resources_1.$bg)(workspaceA.workspaceUri, workspaceB.workspaceUri); // same workspace
            }
            return false;
        }
        hasRemote() {
            if (this.workspace) {
                if ((0, window_1.$RD)(this.workspace)) {
                    return this.workspace.folderUri.scheme === network_1.Schemas.vscodeRemote;
                }
                if ((0, window_1.$QD)(this.workspace)) {
